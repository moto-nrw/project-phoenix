...
| New page, new portal surface, or analytics events | [.claude/rules/usage-analytics.md](.claude/rules/usage-analytics.md); the page guard in `analytics-routes.test.ts` enforces it |
