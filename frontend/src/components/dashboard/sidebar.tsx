...
const NAV_ITEMS: NavItem[] = [
  ...
  {
    // Vertrag (#1459): reine Anzeige des gebuchten Tarifs und der Rechnungen.
    // Steht neben den Einstellungen, weil beides Schulleitungs-Themen sind,
    // und ist wie die Abrechnung an config:manage gebunden.
    ...STAFF_FLAT_PAGES.contract,
    concept: "contract",
