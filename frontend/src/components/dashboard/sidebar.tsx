...
const OPERATOR_NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    label: "Operatoren",
    icon: "M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128H6.875a9.38 9.38 0 01-2.625-.372A4.125 4.125 0 017.533 16.128 9.337 9.337 0 0112 15.176c1.492 0 2.905.35 4.16.972M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z",
