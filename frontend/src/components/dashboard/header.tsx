...
export function Header({
  ...
  const historyType = pathname.includes("/feedback_history")
    ? "Feedback Historie"
    : pathname.includes("/mensa_history")
      ? "Mensa Historie"
      : pathname.includes("/room_history")
          ...
          <div className="flex flex-shrink-0 items-center space-x-4">
            ...
            >
              <div className="relative transition-transform duration-200 group-hover:scale-110">
                ...
                />
                {/* Subtle glow effect */}
                <div className="absolute inset-0 -z-10 h-9 w-9 rounded-full bg-gradient-to-br from-[#5080d8]/20 to-[#83cd2d]/20 blur-sm"></div>
              </div>
            ...
            {pathname.startsWith("/database/") && pathname !== "/database" ? (
              ...
              <nav className="hidden items-center space-x-2 text-base md:flex">
                ...
                <span className="font-medium text-gray-900">Einladungen</span>
              </nav>
              ...
              >
                ...
                <span className="font-medium text-gray-900">{historyType}</span>
              </nav>
          ...
          <div className="ml-auto flex items-center space-x-3">
            ...
            <div className="relative">
              ...
              >
                ...
                <svg
                  className={`h-4 w-4 text-gray-400 transition-all duration-200 ${isProfileMenuOpen ? "rotate-180 text-gray-600" : ""}`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
