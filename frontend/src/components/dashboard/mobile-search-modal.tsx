        ...
        >
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-100 bg-gray-50/50">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#5080d8]/10 to-[#83cd2d]/10 flex items-center justify-center">
                <svg className="w-4 h-4 text-[#5080d8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="px-4 pb-4">
            <h3 className="text-sm font-medium text-gray-700 mb-3">Schnellzugriff</h3>
            <div className="grid grid-cols-2 gap-3">
              {[
                { href: '/students/search', label: 'Alle Schüler', icon: 'user' },
                { href: '/rooms', label: 'Räume', icon: 'building' },
                { href: '/activities', label: 'Aktivitäten', icon: 'clipboard' },
                ...
                <button
                  ...
                  className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:border-[#5080d8]/30 hover:bg-[#5080d8]/5 active:bg-[#5080d8]/10 transition-all duration-200"
                >
