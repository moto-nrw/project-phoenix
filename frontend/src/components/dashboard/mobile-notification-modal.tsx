  ...
  const modalContent = (
    <div className="fixed inset-0 z-[9999] lg:hidden">
      ...
      <div className="fixed inset-x-0 top-0 z-[9999]">
        <div
          ref={modalRef}
          className="mb-safe mx-4 mt-6 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg"
          style={{
            maxHeight:
            ...
            <div className="px-4 pb-3">
              ...
              {unreadCount > 0 && (
                <button
                  ...
                  className="mt-2 w-full py-1.5 text-xs font-medium text-gray-600 transition-colors duration-200 hover:text-gray-900"
                >
              ...
              <div className="px-4 py-2">
                {filteredNotifications.map((notification) => (
                  <button
                    ...
                    className={`mb-2 w-full rounded-lg p-3 text-left transition-all duration-200 ${
                      !notification.isRead
                        ? "border border-blue-100 bg-blue-50/70 hover:bg-blue-50"
                        : "border border-transparent bg-gray-50/50 hover:bg-gray-100"
                    }`}
                  >
                    <div className="flex items-start space-x-3">
                      {/* Mobile Icon - Smaller and more subtle */}
                      <div
                        className={`rounded-lg p-2 ${getMobileNotificationStyles(notification.type, notification.isRead)} flex-shrink-0`}
                      >
