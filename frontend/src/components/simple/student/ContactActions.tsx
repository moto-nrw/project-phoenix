    ...
    <div className="border-t border-gray-200 pt-4">
      ...
      <div className="flex gap-3">
        {email && (
          <Button
            variant="outline"
            className="flex items-center gap-2 transition-colors hover:border-blue-200 hover:bg-blue-50"
        ...
        {phone && (
          <Button
            variant="outline"
            className="flex items-center gap-2 transition-colors hover:border-green-200 hover:bg-green-50"
