...
// seit #3256 im Dialog „Abwesenheit eintragen" ein; die Krankmeldung bleibt
// eigen, weil sie Dienst- und Betreuungsplan ändert.
export function SickReportModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      logger.error("sick_report_create_failed", {
        staff_id: staff.id,
    ...
    >
      {isSuccess ? (
        ...
        <div className="space-y-4">
          ...
          {/* A dedicated <label> around only the checkbox keeps the toggle
