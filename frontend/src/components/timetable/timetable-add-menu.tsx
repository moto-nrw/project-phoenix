...
// Die Kopfkarte klammert jede Schaltfläche darin auf 40 px (44 px mobil),
// auch die Einträge dieses Menüs, das nicht in ein Portal ausweicht. Ein
// Eintrag mit Titel und Erklärzeile ist höher; ohne `h-auto!` rutscht der
// nächste Eintrag über den Text.
const menuItemClass =
  "flex h-auto! w-full items-center gap-3 px-3 py-2.5 text-left transition-colors hover:bg-gray-50 focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:outline-none focus-visible:ring-inset";
  ...
  return (
    ...
    <div className="relative flex-1 sm:flex-none" ref={containerRef}>
      ...
      {open && (
        ...
        >
          <p className="px-3 pt-3 pb-1 text-xs font-semibold tracking-wider text-gray-400 uppercase">
            Termin anlegen
          </p>
