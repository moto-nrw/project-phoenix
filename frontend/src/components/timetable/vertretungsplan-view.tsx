...
// VertretungsplanView is the embeddable Vertretungsplan surface, hosted by
// /planung (#1886 Konsolidierung); formerly the /vertretungsplan page.
export function VertretungsplanView() {
  return (
