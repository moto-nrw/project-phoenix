                        ...
                        <div className="space-y-4">
                            ...
                            <div className="rounded-xl border border-gray-100 bg-blue-50/30 p-3 md:p-4">
                                ...
                                <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-3 md:gap-x-4 gap-y-2 md:gap-y-3">
                                    <div>
                                        ...
                                        <dd className="text-sm font-medium text-gray-900 mt-0.5 break-words">{student.first_name}</dd>
                                    </div>
                                    <div>
                                        <dt className="text-xs text-gray-500">Nachname</dt>
                                        <dd className="text-sm font-medium text-gray-900 mt-0.5 break-words">{student.second_name}</dd>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <dd className="text-sm font-medium text-gray-900 mt-0.5 break-words">{student.group_name ?? "Keine Gruppe"}</dd>
                                    </div>
                                    {student.id && (
                                        <div className="col-span-1 sm:col-span-2">
                                            <dt className="text-xs text-gray-500">Schüler-ID</dt>
                                            <dd className="text-xs md:text-sm font-mono text-gray-600 mt-0.5 break-all">{student.id}</dd>
                                        </div>
                                    )}
                                </dl>
                            </div>
                            ...
                            {student.health_info && (
                                <div className="rounded-xl border border-gray-100 bg-blue-50/30 p-3 md:p-4">
                                    ...
                                    <p className="text-xs md:text-sm text-gray-700 whitespace-pre-wrap break-words">{student.health_info}</p>
                                </div>
                            )}
                            ...
                            {student.supervisor_notes && (
                                <div className="rounded-xl border border-gray-100 bg-blue-50/30 p-3 md:p-4">
                                    ...
                                    <p className="text-xs md:text-sm text-gray-700 whitespace-pre-wrap break-words">{student.supervisor_notes}</p>
                                </div>
                            )}
                            ...
                            <div className="rounded-xl border border-gray-100 bg-blue-50/30 p-3 md:p-4">
                                ...
                                <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-3 md:gap-x-4 gap-y-2 md:gap-y-3">
                                    <div>
                                        ...
                                        <dd className="text-xs md:text-sm font-medium mt-0.5">
                                    ...
                                    {student.data_retention_days && (
                                        <div>
                                            ...
                                            <dd className="text-xs md:text-sm font-medium text-gray-900 mt-0.5">{student.data_retention_days} Tage</dd>
                                        </div>
                                    )}
                                </dl>
                            </div>
                            ...
                            {student.bus && (
                                <div className="rounded-xl border border-orange-200 bg-orange-50 p-3 md:p-4">
                                    <div className="flex items-center gap-2">
                                        <svg className="h-4 w-4 md:h-5 md:w-5 text-orange-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                                        </svg>
                                        <span className="text-xs md:text-sm font-medium text-orange-900">Fährt mit dem Bus</span>
                                    </div>
                                </div>
                            )}
                        </div>
