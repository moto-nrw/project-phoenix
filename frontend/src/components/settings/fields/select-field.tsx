...
export function SelectField({
  ...
  return (
    <select
      ...
      disabled={disabled}
      className="block w-auto max-w-xs min-w-[8rem] rounded-lg border-0 bg-white py-2 pr-8 pl-3 text-sm text-gray-900 shadow-sm ring-1 ring-gray-200 transition-all duration-200 ring-inset focus:outline-none focus:ring-inset focus-visible:ring-2 focus-visible:ring-gray-400 disabled:bg-gray-50 disabled:text-gray-500"
    >
      {options.map((opt) => (
