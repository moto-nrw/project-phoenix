...
/**
 * Ersteinrichtung: flat, dependency-ordered sequence. The order is
 * intentional: staff before groups (group leader), rooms before groups
 * (groups assign a room), rooms + staff before activities, groups before
 * the child import (so the import can map children to groups).
 */
export const setupSteps: readonly GuideStep[] = [
  {
    id: "konto-erstellen",
  ...
  },
  {
    ...
    screenshot: "Räume-Liste in der Datenverwaltung mit Beispiel-Einträgen.",
...
/**
 * "Die App im Alltag": one card per sidebar item, in the real top-to-bottom
 * order of the staff sidebar, so the documentation maps 1:1 to what users see.
 */
export const appSidebarSections: readonly GuideStep[] = [
  {
    id: "kindersuche",
    title: "Kindersuche",
    icon: Search,
  ...
  },
  {
    ...
    screenshot: "Räume-Übersicht mit Statusfilter, Frei/Belegt und Unterwegs.",
  ...
  },
  {
    ...
    screenshot: "Mitarbeiterliste mit Status-Badges und aktiven Aufsichten.",
  ...
  },
  {
    ...
    screenshot: "Stundenplan-Kalender mit Termin, Serien und Jetzt starten.",
  ...
  },
  {
    ...
    screenshot: "Feedback-Übersicht mit Suche, Neuer Beitrag und Statusfilter.",
    image: "/anleitung/screens/feedback.png",
  },
];

/** NFC & Tablets: additional preparation steps, only for NFC schools. */
export const nfcSteps: readonly GuideStep[] = [
  {
    ...
    screenshot: "Kindersuche mit eindeutig gefundenem Kind vor NFC-Zuweisung.",
  },
  {
    id: "nfc-namen",
  ...
  },
  {
    ...
    screenshot: "Gerätedetail mit Geräte-ID, Gerätetyp, Status und Verbindung.",
  },
  {
