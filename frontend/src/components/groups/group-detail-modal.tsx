...
import { OGSettingsModal } from "~/components/settings";
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="">
      {loading ? (
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          {/* Settings Button */}
          <div className="rounded-xl border border-gray-100 bg-gray-50/50 p-3 md:p-4">
            <button
              onClick={() => setShowSettingsModal(true)}
              className="flex w-full items-center justify-between rounded-lg bg-white px-4 py-3 text-left transition-colors hover:bg-green-50"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Abholzeiten, Sitzungen und mehr
                  </p>
                </div>
              </div>
              <svg
