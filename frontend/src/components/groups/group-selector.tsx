  ...
  return (
    <div className="w-full">
      ...
      <select
        ...
        disabled={loading}
        required={required}
        className={`w-full rounded-lg border border-gray-300 px-4 py-2 transition-all duration-200 focus:ring-2 focus:ring-blue-500 focus:outline-none ${className} ${loading ? "opacity-50" : ""}`}
      >
        {includeEmpty && (
