// Tagesstatus-Beschriftung der Klassenansicht — eine Quelle für alle
// Abschnitte einer Klassenseite (#2294). Zwei Stellen mit eigenen Wörtern
// für denselben Status wären genau der Missverständnis-Fall, den
