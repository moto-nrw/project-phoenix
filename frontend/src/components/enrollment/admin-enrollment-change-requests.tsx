        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-gray-600">
              Prüfe Korrekturen, die Familien nach der ersten Entscheidung
              eingereicht haben. Freigegebene Änderungen werden in die Anmeldung
        ...
        <div className="grid gap-0 lg:grid-cols-[minmax(0,1fr)_360px] xl:grid-cols-[minmax(0,1fr)_420px]">
          <div className="space-y-5 p-5 sm:p-6">
            <header>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-gray-600">
                Vergleiche die eingereichten Änderungen mit dem gespeicherten
                Stand. Rückfragen pausieren die Prüfung, Freigabe übernimmt die
                Änderung in die Anmeldung.
              </p>
            </header>
              ...
              <section className="moto-content-surface rounded-2xl border p-4 shadow-sm">
                ...
                <div className="mt-3 grid gap-2 sm:grid-cols-2">
                  <button
                    ...
                    disabled={!canReview || busy !== null || !reviewNote.trim()}
