...
import { ManualApprovedEnrollmentModal } from "./phase-enrollment-actions";
...
const meta = {
  title: "components/enrollment/ManualApprovedEnrollmentModal",
  component: ManualApprovedEnrollmentModal,
  args: {
    isOpen: true,
    onClose: () => undefined,
    phase,
...
} satisfies Meta<typeof ManualApprovedEnrollmentModal>;
