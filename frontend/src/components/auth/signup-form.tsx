...
export function SignupForm() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      // BetterAuth signUp.email() for email/password registration
      ...
      // After successful signup, try to set active organization
      try {
        ...
        // Organization setup is optional - user might need to be added to one
        console.log("No organizations available for new user");
      }

      toastSuccess(
        "Registrierung erfolgreich! Du wirst zur Startseite weitergeleitet.",
      );
