...
export function PermissionListItem({ permission, onClick }: PermissionListItemProps) {
    ...
    >
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex items-start gap-3 md:items-center">
          {/* Permission Icon */}
          <div className="flex h-10 w-10 md:h-12 md:w-12 shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-amber-400 to-orange-500 font-medium text-white text-sm md:text-base">
