...
export function MFAAdminOverrideModal({
  ...
  return (
    <Modal
      ...
      isDismissDisabled={isWorking || overrideWorking || globalWorking}
      ...
      <div className="mb-4">
        ...
        {stateLoaded && (
          <p className="mt-1 text-xs text-gray-500">
            Aktueller Status:{" "}
            {overrideLabel(scope === "operator" ? globalOverride : override)}
            {enrolled
          ...
          <section className="mb-6">
            ...
            >
              <p className="text-sm text-gray-600">
                ...
                durch das 2FA-Setup geführt. Die Aktion wird im Audit-Log mit
                Ihrem Konto und dem angegebenen Grund erfasst.
              </p>
          ...
          {scope === "operator" && (
            <section className="mt-6 rounded-lg border-2 border-[#FFCDB8] bg-[#FFFBEB] p-4">
              ...
              <p className="mb-3 text-xs text-gray-700">
                ...
                Nur einsetzen, wenn der Mitarbeiter komplett keinen Zugriff auf
      ...
      {view.kind === "reset-done" && (
        <div className="space-y-4">
          <p className="text-sm text-gray-700">
            ...
            vollständig entfernt. Beim nächsten Login kann sich der Account ohne
            2FA-Code anmelden — oder wird, wenn 2FA für die Schule Pflicht ist,
            durch die 2FA-Einrichtung geführt.
          </p>
