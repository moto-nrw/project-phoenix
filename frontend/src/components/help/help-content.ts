...
function createStudentTopic(): HelpTopic {
  return {
    ...
    troubleshootingDetails: [
      ...
      "moto meldet, das Kinderkontingent ist voll? Dann sind alle gebuchten Plätze belegt. Ihre Eingaben bleiben im Fenster. Für weitere Kinder melden Sie sich beim moto-Team.",
    ],
    related: [
