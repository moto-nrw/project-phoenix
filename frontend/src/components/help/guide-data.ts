    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Im selben Dialog stehen zusätzlich die Formate `DATEV LODAS` und `DATEV Lohn und Gehalt` bereit: Bewegungsdaten für die Lohnabrechnung, immer ein einzelner Monat pro Datei, mit einer Zeile je Person und Lohnart. Voraussetzung ist die vollständige Konfiguration unter `Abrechnung` (Lohnarten, für LODAS auch Berater- und Mandantennummer) sowie Personalnummern an den Personen. Vor dem Download zeigt der Dialog einen Bericht: wie viele Buchungszeilen entstehen, wer mangels Personalnummer übersprungen wird und ob der Monat noch offen ist. Die erste Datei vor dem Echtlauf mit der Lohnbuchhaltung abstimmen; bei Lohn und Gehalt legt das Lohnbüro die Importbeschreibung selbst an.",
