    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Im offenen Raum steht oben `Offener Raum`. Dort lesen Sie auch, ob Sie hier die Aufsicht haben. Den Raum zu sehen heißt nicht, dass Sie dort die Aufsicht haben.",
          ...
          "Den Schulhof über seinen Raum und `Beaufsichtigen` führen. Läuft dort bereits eine Aufsicht oder ein gestarteter Termin, treten Sie als weitere Aufsicht bei; sonst startet eine spontane Schulhof-Aufsicht. Im Dialog für eine spontane Aktivität lässt sich der Raum `Schulhof` wie jeder andere Raum wählen.",
