    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Offene Anfragen sind nach Kind gebündelt. So sehen Sie alle Wünsche für ein Kind in einem Fall.",
          "Fälle, die heute wichtig sind, stehen oben unter `Heute wichtig`. Alle anderen Fälle stehen unter `Später`.",
          "Für einfache Anfragen können Sie die Auswahl links markieren. Tragen Sie eine gemeinsame Begründung ein und wählen Sie `Freigeben`. moto gibt dann entweder alle ausgewählten Anfragen frei oder keine.",
          "Anfragen mit weiteren Folgen, zum Beispiel Änderungen an Angeboten, entscheiden Sie weiterhin einzeln. moto nennt den Grund direkt an der Auswahl.",
          "Ohne ausdrückliche Freigabe sehen andere Sorgeberechtigte nur den wirksamen Stand des Kindes. Wer eine Anfrage gestellt hat, Hinweise und Begründungen bleiben privat.",
          "Admins können für ein Kind `Familienschutz` einschalten. Die Funktion steht am Fall und in der Kinderkartei unter `Stammdaten`. Der Grund, die handelnde Person und der Zeitpunkt bleiben im Verlauf erhalten.",
    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "In der Seitenleiste `Anfragen` öffnen; der Reiter `Eltern` ist voreingestellt. moto bündelt alle offenen Wünsche eines Kindes in einem Fall. Fälle, die heute wichtig sind, stehen zuerst unter `Heute wichtig`. Die anderen Fälle stehen unter `Später`. Über das Suchfeld nach dem Namen eines Kindes suchen, über den Filter `Anfrageart` gezielt eine Sorte anzeigen (`Stammdaten`, `Betreuungszeiten`, `Angebote und AGs`, `Abwesenheiten`, `Anmeldung`). Für Betreuungszeiten kommen keine neuen Anfragen mehr; noch offene Altfälle lassen sich weiterhin entscheiden.",
          "Für einfache Anfragen können Sie links mehrere Haken setzen. Tragen Sie eine gemeinsame Begründung ein und wählen Sie `Freigeben`. moto gibt entweder alle ausgewählten Anfragen frei oder keine. Anfragen mit weiteren Folgen bleiben einzeln zu prüfen; der Grund steht direkt an der Auswahl.",
          "Ohne ausdrückliche Freigabe sehen andere Sorgeberechtigte nur den wirksamen Stand des Kindes. Name, Hinweise und Begründungen der einreichenden Person bleiben privat. Admins können den `Familienschutz` am Fall oder in der Kinderkartei unter `Stammdaten` einschalten und aufheben; jede Änderung wird mit Grund, Person und Zeitpunkt festgehalten.",
        ...
        callout: {
          ...
          body: "Standardmäßig entscheiden nur OGS-Admins. Unter `Einstellungen` > `Elternportal` können Admins zusätzlich erlauben, dass Gruppenleitungen Anfragen für Kinder ihrer eigenen Gruppen entscheiden. Solange eine Anfrage offen ist, können Eltern sie im Kinderbereich zurückziehen.",
          tone: "orange",
        },
        screenshot:
          "Seite Anfragen, Reiter Eltern: Fälle unter Heute wichtig und Später, Sammelfreigabe und Familienschutz.",
