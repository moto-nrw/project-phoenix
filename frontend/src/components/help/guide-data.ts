    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Unter dem Kalender `Kalender abonnieren` öffnen. Dann `Abo-Link anzeigen` wählen.",
          ...
          "Das Abo ist nur zum Lesen. Änderungen im persönlichen Kalender wirken nicht auf moto zurück. Der Link wird nur einmal angezeigt und darf nicht weitergegeben werden.",
