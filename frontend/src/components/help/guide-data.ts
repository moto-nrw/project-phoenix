    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Nur bei zusätzlichem Bedarf über `Neue Vorlage` eine eigene Formularvorlage mit Zusatzfragen anlegen. Für Betreuungsangebote mit Tagesauswahl immer den Stammdaten-Vorschlag `Erlaubte Heimwege` nutzen: Eltern sehen dann nur die gewählten Betreuungstage und wählen pro Betreuungstag mindestens einen Heimweg, zum Beispiel zu Fuß, Bus, Abholung oder mit anderem Kind. Alte Felder wie `Buskind`, `Abholregelung` oder `Geh- und Abholregelung` in bestehenden Vorlagen ersetzen, wenn die Phase mit Betreuungsangeboten arbeitet. Bei `mit anderem Kind` ergänzen Eltern im Pflichtfeld, mit wem das Kind nach Hause geht.",
