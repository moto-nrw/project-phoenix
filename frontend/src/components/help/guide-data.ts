    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Offene Anfragen stehen nach Kind zusammen. Der Name steht einmal über allen Anfragen des Kindes.",
          "Kinder, die heute betroffen sind, stehen unter `Heute wichtig`. Alle anderen Fälle stehen unter `Weitere Anfragen`.",
          ...
          "Anfragen mit weiteren Folgen entscheiden Sie einzeln. An der Anfrage steht dann `Nur einzeln freigeben`.",
    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Öffnen Sie in der Seitenleiste `Anfragen`. Der Reiter `Eltern` ist schon gewählt. Alle offenen Anfragen eines Kindes stehen in einem Fall. Kinder, die heute betroffen sind, stehen unter `Heute wichtig`. Alle anderen Fälle stehen unter `Weitere Anfragen`.",
          "Markieren Sie bei passenden Anfragen `Gemeinsam freigeben`. Tragen Sie einen gemeinsamen Grund ein. moto gibt entweder alle ausgewählten Anfragen frei oder keine. Andere Anfragen tragen den Hinweis `Nur einzeln freigeben`.",
