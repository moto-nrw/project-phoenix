    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Im Feld `Gültig ab` steht, ab wann die Umstellung gilt. Vorbelegt ist der Wunsch der Eltern; daneben steht die Kalenderwoche. Sie können vor dem Freigeben ein anderes Datum wählen, frühestens heute und innerhalb der Betreuungszeit.",
