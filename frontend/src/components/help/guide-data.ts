  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          "Teammitglieder ohne Admin-Rechte öffnen den `Betreuungsplan` direkt über die Seitenleiste (unter `Mein Kalender`). Oben steht `Nur ansehen`: Sie sehen die Wochenplanung der ganzen Schule – wer macht was, wann, wo und mit welchen Kindern (Teilnehmerliste im Termin-Detail). Die Ansicht zeigt bewusst nur die Woche; Planungswerkzeuge wie Monats- und Serienansicht, Lücken- und Konflikthinweise sowie Anlegen, Bearbeiten, Absagen und Löschen bleiben Admins vorbehalten.",
