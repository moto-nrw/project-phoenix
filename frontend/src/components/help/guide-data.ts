    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "`Rest des Tages` entschuldigt diesen Block und alle späteren Blöcke von heute. Frühere Blöcke bleiben, wie sie sind. Den Eintrag finden und entfernen Sie auf der Seite des Kindes. Wer keine Kinderdaten ändern darf, entschuldigt nur diesen Block.",
