    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Mit `Freigeben` wird die Änderung übernommen. Bei einer Tages-Abholzeit zeigt moto vorher die betroffenen Termine im Betreuungsplan. Das Kind wird nach dem Freigeben von diesen Terminen abgemeldet. Bei Betreuungszeiten wird der Wochenplan aktualisiert. Bei Abwesenheiten trägt moto das Kind als krank oder entschuldigt ein.",
