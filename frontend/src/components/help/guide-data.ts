    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Optional ordnen Sie einen Regeltermin in Schritt 1 einer `Planungsspur` zu. Farbe und Name der Spur kennzeichnen den Block in Wochen- und Monatsansicht; die Legende zeigt nur Spuren, die im sichtbaren Zeitraum verwendet werden. Ohne Zuordnung erscheint der Block neutral. Über `Verwalten` legen Admins Spuren mit Name und Farbe an, ändern ihre Reihenfolge oder archivieren sie. Archivierte Spuren bleiben an bestehenden Regelterminen lesbar und bearbeitbar, stehen für neue Zuordnungen aber nicht mehr bereit; unter `Archiviert` lassen sie sich wiederherstellen.",
