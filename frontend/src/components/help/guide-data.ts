    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Noch im Schritt `Inhalt`: unter `Erinnerung` optional ein Datum und eine Uhrzeit wählen. moto schickt die Mitteilung dann zu diesem Zeitpunkt noch einmal an alle Empfänger, egal ob sie schon gelesen oder bestätigt haben. Mit einem kurzen `Erinnerungstext` bringen Sie das Wichtigste auf den Punkt, zum Beispiel „Morgen endet die Betreuung um 13:00 Uhr.“; ohne eigenen Text geht der Text der Mitteilung erneut raus. Die Erinnerung geht über dieselben Wege wie die Mitteilung selbst (Elternportal, Push und, falls eingeschaltet, E-Mail) und darf nicht nach dem Ablaufdatum liegen.",
