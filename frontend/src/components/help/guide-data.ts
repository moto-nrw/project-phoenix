  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          "`Vertretung` in der Seitenleiste öffnen. Die Seite zeigt zunächst den heutigen Tag.",
      ...
      },
      {
        ...
        steps: [
          ...
          "Fällt eine Person ganztägig aus, über das Thermometer-Symbol am Namen `Krank melden` öffnen und Zeitraum sowie optional eine Notiz erfassen. Die Krankmeldung storniert reguläre Schichten im Zeitraum (Grund `Krankheit`) und markiert betroffene Betreuungsblöcke als abwesend. Bereits eingetragene Vertretungsschichten bleiben bestehen und müssen manuell geprüft werden. `Zur Vertretung` führt anschließend direkt in die Tagesansicht des Vertretungsplans, um offene Blöcke neu zu besetzen. Ein halber Tag gilt für ein einzelnes Datum und ändert Dienst- und Betreuungsplan nicht automatisch.",
