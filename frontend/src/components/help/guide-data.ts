    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Mit `Freigeben` wird die Änderung übernommen: Bei Betreuungszeiten wird der Wochenplan des Kindes aktualisiert, bei Abwesenheiten wird das Kind für die angefragten Tage als krank oder entschuldigt eingetragen.",
