    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Tab `Betreuungszeiten`: die Ankunfts- und Abholzeiten des Kindes verwalten. Auf einen Tag in der Wochenübersicht klicken öffnet den Editor; oben wählen Sie unter `Gilt für`, wie weit die Änderung reicht: `Nur an diesem Tag`, `An mehreren Tagen` (Zeitraum mit Enddatum, Wochenenden werden übersprungen) oder `Jeden Montag` und so weiter, was den Wochenplan dauerhaft ändert. Die Schaltfläche `Wochenplan` oben rechts öffnet direkt den Wochenplan mit allen Tagen. Neben `Regulär` und `Andere Zeit` lässt sich auch `Kommt nicht` bzw. `Keine Abholung` eintragen. Notizen gelten entweder nur für den gewählten Tag oder, wenn sie im Wochenplan hinterlegt sind, für jede Woche; im Tageseditor sind Wochennotizen mit `Jede Woche` gekennzeichnet und über `Im Wochenplan ändern` erreichbar.",
