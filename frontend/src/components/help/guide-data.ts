    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Tab `Stammdaten`: Name, Klasse, Gruppe, Geburtstag, Adresse, Gesundheitsinformationen, Notizen, Foto und Datenschutz ansehen und über `Bearbeiten` ändern. Unter `Erlaubte Heimwege` legen Sie je Wochentag fest, wie das Kind nach Hause kommt; darunter tragen Sie unter `Läuft mit` die Kinder ein, mit denen es gemeinsam geht (Laufgemeinschaft). Pro verknüpftem Kind wählen Sie die Wochentage aus, an denen die beiden zusammen gehen. Die Verknüpfung gilt immer für beide Kinder: Wer bei Lina eingetragen ist, hat Lina automatisch auch auf seiner eigenen Karte stehen. Wenn das Kind über eine Online-Anmeldung übernommen wurde, stehen dort auch kindbezogene Zusatzantworten aus dem Anmeldeformular zur Ansicht.",
