    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Schritt 3 `Personal und Kinder`: `Personal` und einzelne `Kinder` zuordnen. Suche und Filter helfen bei langen Kinderlisten. Hier erscheinen auch Hinweise zu doppelt belegten Räumen, Personal oder Kindern sowie zum Abgleich mit dem Dienstplan; sie verhindern das Speichern nicht.",
