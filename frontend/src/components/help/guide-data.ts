    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Die Leitung startet mit sechs Kennzahlen (`Kinder anwesend`, `Krank`, `Entschuldigt`, `Zuhause`, `Schule`, `Schulhof`), den `Offenen Anfragen`, `Personal heute`, den `Tagesinformationen`, dem `Ablauf des Tages`, den `Ungelesenen Nachrichten` und der `Laufenden Betreuung`. Wer die Einrichtung leitet und selbst betreut, bekommt beides: den eigenen Tag vorneweg, die Lage der Schule dahinter.",
