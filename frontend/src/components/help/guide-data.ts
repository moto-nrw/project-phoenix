    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Wenn Betreuungstage frei gepflegt werden: Betreuungstage wählen und die regelmäßige `Abholung` eintragen.",
          "Wenn Betreuungstage aus Buchungen kommen: nur die regelmäßige `Abholung` eintragen. Ankunftszeiten tragen Sie nach der Buchung im Wochenplan ein.",
      ...
      },
      {
        ...
        steps: [
          ...
          "Für die Abholung je Wochentag eine Uhrzeit eintragen.",
