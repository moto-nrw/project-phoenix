    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Tab `Änderungsprotokoll`: alle entschiedenen Anfragen zu diesem Kind in einer Liste, neueste zuerst. Wer Kinderdaten bearbeiten darf, sieht Stammdaten, Betreuungszeiten, Angebote, Entschuldigungen und Direkt-Korrekturen der OGS. Mit der Berechtigung nur für Abwesenheiten sehen Sie nur Entschuldigungen. Direkt-Korrekturen sind dann nicht sichtbar. Jeder Eintrag zeigt Vorher → Nachher, wer entschieden hat, wann und mit welcher Begründung. So ist am Kind nachvollziehbar, warum es zum Beispiel seit dieser Woche früher geht. Den Reiter sieht, wer Kinderdaten bearbeiten oder Abwesenheiten entscheiden darf.",
      ...
      },
      {
        ...
        steps: [
          ...
          "Offene Anfragen finden Sie als Admin in der Seitenleiste unter `Anfragen` im Reiter `Eltern`: `Stammdaten`, `Betreuungszeiten`, `Betreuungsangebote und AGs`, – falls aktiviert – `Entschuldigte Abmeldungen` und Änderungen an noch nicht übernommenen Anmeldungen (`Anmeldung`).",
    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "In der Seitenleiste `Anfragen` öffnen; der Reiter `Eltern` ist voreingestellt. Alle offenen Anfragen stehen in einer gemeinsamen Liste, jeweils mit dem Vergleich `aktuell -> gewünscht`. Über das Suchfeld nach dem Namen eines Kindes suchen, über den Filter `Anfrageart` gezielt eine Sorte anzeigen (`Stammdaten`, `Betreuungszeiten`, `Angebote und AGs`, `Entschuldigungen`, `Anmeldung`). Für Betreuungszeiten kommen keine neuen Anfragen mehr; noch offene Altfälle lassen sich weiterhin entscheiden.",
