    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Blöcke anderer Betreuungskräfte sind eingeklappt. Im Kopf stehen die Uhrzeit, die Zahl der Kinder und `Sie sind hier nicht eingeplant.` Mit dem Pfeil klappen Sie die Liste auf. Eintragen können dort nur die eingeplanten Betreuungskräfte.",
          "`Betreuer hinzufügen` steht im Kopf jedes Blocks, den Sie beaufsichtigen.",
          ...
          "Läuft im Raum kein Block, zum Beispiel auf dem Schulhof mit Tablet, sehen Sie alle Kinder in einer Liste. Bei jedem Kind steht sein Angebot oder `Ohne Angebot`.",
