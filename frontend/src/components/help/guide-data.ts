    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "`Entfernen` löscht die Vertretung nur aus dem geöffneten Termin. Das geht auch, wenn die Ersatzperson dort als abwesend steht. Andere Termine und der Regeltermin im Betreuungsplan bleiben unverändert. `Anwesend melden` erscheint nur, wenn im Termin noch eine geplante Position frei ist.",
