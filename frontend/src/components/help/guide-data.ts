    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Mit Genehmigungsrecht für Abwesenheiten gibt es daneben den Reiter `Mitarbeitende`: Urlaubs-, Krank-, Fortbildungs- und sonstige Anträge des Teams, offen wie Historie, mit Suche nach Namen und Filter nach Art. Pro Antrag lässt sich `Genehmigen`, `Ablehnen` (mit Begründung) oder eine `Rückfrage` mit Notiz an die Person stellen.",
    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Mit Genehmigungsrecht steht oben auf der Seite ein Verweis `Anträge von Mitarbeitenden` mit der Zahl der offenen Anträge. Entschieden wird in der Seitenleiste unter `Anfragen` im Reiter `Mitarbeitende`.",
