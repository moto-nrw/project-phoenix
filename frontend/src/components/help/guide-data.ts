    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Hinterlegte Schließtage sind in der Wochenansicht als graue Tagesspalte mit dem Vermerk `Schließtag` und dem Grund erkennbar, in der Halbjahres-Sicht als Kennzeichnung an der betroffenen Kalenderwoche. Eine Schicht lässt sich trotzdem einplanen (z. B. pädagogischer Tag oder Notbetreuung): Vor einer einzelnen Schicht fragt die App einmal nach; bei einer Serie prüft sie nach der Wiederholungsauswahl alle tatsächlich erzeugten Schichten. Der Dialog `Verschieben nach` weist auf einen Schließtag am Zieltag hin.",
