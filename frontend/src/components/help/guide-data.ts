    ...
    steps: [
      {
        ...
        steps: [
          ...
          "Jeder Bereich (etwa `Elternportal` oder `Zeiterfassung`) ist zunächst zugeklappt und zeigt nur seinen Namen und die enthaltenen Einstellungen in einer Zeile. Auf die Überschrift klicken, um ihn zu öffnen; `Alle ausklappen` öffnet alle Bereiche des Reiters. Ein Abzeichen wie `2 geändert` zeigt, wie viele Einstellungen darin vom Standard abweichen.",
