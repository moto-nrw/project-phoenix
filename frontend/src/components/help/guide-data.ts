  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        steps: [
          "Teammitglieder ohne Admin-Rechte öffnen den `Betreuungsplan` direkt über die Seitenleiste. Oben steht `Nur ansehen`: Sie sehen die ganze Wochenplanung der Schule – wer macht was, wann, wo und mit welchen Kindern (Teilnehmerliste im Termin-Detail). Anlegen, Bearbeiten, Absagen und Löschen bleiben Admins vorbehalten.",
