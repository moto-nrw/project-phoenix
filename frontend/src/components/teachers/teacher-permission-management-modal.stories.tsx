...
const meta = {
  title: "components/teachers/TeacherPermissionManagementModal",
  component: TeacherPermissionManagementModal,
  decorators: [
    (Story) => (
      <ToastProvider>
        <Story />
...
} satisfies Meta<typeof TeacherPermissionManagementModal>;
