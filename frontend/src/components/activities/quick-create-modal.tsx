  ...
  const modalContent = (
    ...
    >
      ...
      {loading ? (
        ...
        {/* Footer */}
        <div className="flex gap-3 p-4 md:p-6 border-t border-gray-100 bg-gray-50/50">
          <button
            type="button"
            onClick={handleClose}
          ...
          <button
            ...
            className="flex-1 px-4 py-2 rounded-lg bg-gradient-to-br from-[#83CD2D] to-[#70B525] text-sm font-medium text-white hover:from-[#73BD1D] hover:to-[#60A515] hover:shadow-lg hover:scale-105 active:scale-100 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 transition-all duration-200"
          >
            {isSubmitting ? (
