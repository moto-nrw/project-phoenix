...
function prepareTeacherForBackend(
  data: Partial<Teacher> & { password?: string; birthday?: string },
        ...
        items: [
          {
            label: "Fachgebiet",
            value: (teacher: Teacher) =>
              teacher.specialization ?? "Nicht angegeben",
          },
          {
            label: "Rolle",
          ...
          },
          {
            label: "Qualifikationen",
            value: (teacher: Teacher) =>
              teacher.qualifications ?? "Keine angegeben",
            colSpan: 2,
          },
          {
            label: "Interne Notizen",
              ...
              if (!teacher.account_id) {
                return (
                  <div className="text-sm text-gray-500">
                    Kein Konto verknüpft - Erstellen Sie ein Konto, um
              ...
              return (
                <div className="space-y-2">
                  <div className="text-sm">
                    <span className="font-medium">Konto-ID:</span>{" "}
                    {teacher.account_id}
                  </div>
                  {teacher.email && (
                    <div className="text-sm">
                  ...
                  <div className="mt-2 text-xs text-gray-500">
                    Verwenden Sie die Aktionsbuttons oben, um Rollen und
