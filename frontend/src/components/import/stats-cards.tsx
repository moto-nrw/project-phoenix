...
const StatCard: React.FC<StatCardProps> = ({
  ...
  <div className="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white/90 shadow-[0_4px_20px_rgb(0,0,0,0.08)] backdrop-blur-md transition-all duration-150 hover:-translate-y-0.5 hover:shadow-sm">
    <div
