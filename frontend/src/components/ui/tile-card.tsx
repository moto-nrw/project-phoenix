...
export const TILE_CARD_SURFACE =
  "group moto-content-surface moto-hover-elevated relative block w-full overflow-hidden rounded-2xl border border-gray-200 max-sm:rounded-xl bg-white text-left shadow-sm focus-visible:ring-2 focus-visible:ring-gray-300 focus-visible:ring-offset-2 focus-visible:outline-none";
