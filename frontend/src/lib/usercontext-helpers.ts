...
export function mapEducationalGroupResponse(data: BackendEducationalGroup): EducationalGroup {
    return {
        id: data.id.toString(),
        name: data.name,
...
export function mapActivityGroupResponse(data: BackendActivityGroup): ActivityGroup {
    return {
        id: data.id.toString(),
        name: data.name,
        room_id: data.room_id?.toString(),
