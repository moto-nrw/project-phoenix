...
export function getThemeClassNames(theme: DatabaseTheme) {
  const classMap = {
    ...
    gradient: {
      "from-teal-500 to-blue-600":
        theme.primary === "teal-500" && theme.secondary === "blue-600",
      "from-purple-500 to-indigo-600":
        theme.primary === "purple-500" && theme.secondary === "indigo-600",
      "from-green-500 to-emerald-600":
        theme.primary === "green-500" && theme.secondary === "emerald-600",
      "from-orange-500 to-red-600":
        theme.primary === "orange-500" && theme.secondary === "red-600",
      "from-indigo-500 to-purple-600":
        theme.primary === "indigo-500" && theme.secondary === "purple-600",
      "from-gray-500 to-slate-600":
        theme.primary === "gray-500" && theme.secondary === "slate-600",
      "from-amber-500 to-orange-600":
        theme.primary === "amber-500" && theme.secondary === "orange-600",
    },
  ...
  return {
    gradient:
      Object.entries(classMap.gradient).find(([_, match]) => match)?.[0] ?? "",
    background:
      Object.entries(classMap.background).find(([_, match]) => match)?.[0] ??
      "",
    border:
      Object.entries(classMap.border).find(([_, match]) => match)?.[0] ?? "",
