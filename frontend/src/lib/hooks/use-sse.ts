    ...
    const connect = () => {
      ...
      try {
        ...
        const eventTypes = [
          ...
          // Group handovers and Vertretungen (#2084). Same named-event rule:
          // unregistered means the handler in useGlobalSSE never runs and a
          // group handed to this user stays invisible until a reload.
