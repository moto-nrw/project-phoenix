...
const CACHE_KEY = "messages_unread_count";
const CACHE_DURATION_MS = 60 * 1000; // 1 minute cache
const REFRESH_EVENT = "messages-unread-refresh";
...
export function useMessagesUnread() {
  ...
  // Listen for refresh events triggered elsewhere (e.g. inbox/thread updates)
  useEffect(() => {
