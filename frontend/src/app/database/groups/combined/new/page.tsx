...
export default function NewCombinedGroupPage() {
  ...
  const handleCreateCombinedGroup = async (combinedGroupData: Partial<CombinedGroup>) => {
    try {
      setLoading(true);
      setError(null);
      ...
      setError('Fehler beim Erstellen der Gruppenkombination. Bitte versuchen Sie es später erneut.');
