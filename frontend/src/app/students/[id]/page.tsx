  ...
  return (
    <ResponsiveLayout studentName={student.name} referrerPage={referrer}>
      <div className="mx-auto max-w-7xl px-4 pb-6 sm:px-6 lg:px-8">
        ...
        {/* Checkout Section - Only for supervisors and when student is present */}
        {hasFullAccess && student.current_location?.startsWith("Anwesend") && (
        ...
        {/* History Section - Only for supervisors */}
        {hasFullAccess && (
          <InfoCard
            title="Historien"
            icon={
        ...
        {/* Personal Information - Visible to all staff */}
        <div className="mt-4 space-y-4 sm:mt-6 sm:space-y-6">
          <div className="rounded-2xl border border-gray-100 bg-white/50 p-4 backdrop-blur-sm sm:p-6">
            <div className="mb-4 flex items-center justify-between">
              ...
              {hasFullAccess && !isEditingPersonal && (
                <button
                  onClick={() => {
            ...
            <div className="space-y-3">
              {isEditingPersonal && hasFullAccess && editedStudent ? (
                <>
                  <div>
