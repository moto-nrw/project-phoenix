  ...
  return (
    <ResponsiveLayout>
      <div className="-mt-1.5 w-full">
        ...
        {/* Desktop Content - iOS Card Style */}
        {!isMobile && (
          <div className="mx-6 max-w-2xl space-y-6">
            {/* Profile Card */}
              ...
              <div className="p-6">
                <div className="flex items-start gap-6">
                  ...
                  <div className="group relative flex-shrink-0">
                    <div className="relative flex h-20 w-20 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-gray-700 to-gray-900 text-white shadow-lg">
                      {profile?.avatar ? (
                        <Image
                          src={profile.avatar}
                          alt="Profile"
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div>
                        ...
                        <input
                          ...
                          disabled={!isEditing}
                          className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm transition-all focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none disabled:bg-gray-50 disabled:text-gray-500"
                        />
                      </div>
                      <div>
                        <label className="mb-1.5 block text-sm font-medium text-gray-700">
              ...
              <div className="p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      Passwort und Anmeldedaten verwalten
                    </p>
                  </div>
                </div>
                <div className="mt-4">
