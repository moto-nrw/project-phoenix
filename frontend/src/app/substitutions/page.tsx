...
function SubstitutionPageContent() {
    ...
    // Handle ending substitution
    const handleEndSubstitution = async (substitutionId: string) => {
        try {
            setIsLoading(true);
    ...
    return (
        <ResponsiveLayout>
            <div className="w-full -mt-1.5">
                ...
                <div className="mb-6">
                    <h2 className="text-lg font-semibold text-gray-900 mb-4">Verfügbare pädagogische Fachkräfte</h2>
                                ...
                                >
                                    ...
                                    <div className="relative flex items-center justify-between p-5">
                                        ...
                                        <div className="flex items-center gap-4 flex-1 min-w-0">
                                            {/* Teacher initial circle - simple design */}
                ...
                <div>
                    <h2 className="text-lg font-semibold text-gray-900 mb-4">Aktuelle Vertretungen</h2>
                        ...
                        <div className="space-y-3">
                            {activeSubstitutions.map((substitution) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Modern gradient overlay */}
                                        <div className="absolute inset-0 bg-gradient-to-br from-purple-50/80 to-pink-100/80 opacity-[0.03] rounded-3xl"></div>
                                        {/* Subtle inner glow */}
                                        <div className="absolute inset-px rounded-3xl bg-gradient-to-br from-white/80 to-white/20"></div>
                                        {/* Modern border highlight */}
                                        ...
                                        <div className="relative flex items-center justify-between p-5">
                                            ...
                                            <div className="flex items-center gap-4 flex-1 min-w-0">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-sm text-gray-500 mt-1">
                                                        ...
                                                        <span className="font-medium text-gray-700">{substitution.substituteStaffName}</span>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <button
                                                onClick={() => handleEndSubstitution(substitution.id)}
                                                disabled={isLoading}
                                                className="px-4 py-2 rounded-xl text-sm font-medium bg-red-100 text-red-700 hover:bg-red-200 transition-colors duration-200 active:scale-95 whitespace-nowrap ml-4"
                                            >
                                                Beenden
                                            </button>
                                        </div>
            ...
            {showPopup && selectedTeacher && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm p-4">
                    <div className="w-full max-w-md rounded-3xl bg-white border border-gray-200 shadow-2xl">
                        <div className="p-6">
                            <h2 className="text-xl font-bold text-gray-800 mb-6">Vertretung zuweisen</h2>

                            <div className="mb-6">
                                <p className="text-sm font-medium text-gray-700 mb-2">Pädagogische Fachkraft:</p>
                                <p className="font-semibold text-gray-900">{formatTeacherName(selectedTeacher)}</p>
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <select
                                    ...
                                    className="block w-full rounded-xl border-0 px-4 py-3 text-base shadow-sm ring-1 ring-gray-200 transition-all duration-200 hover:ring-gray-300 focus:ring-2 focus:ring-gray-400 focus:outline-none"
                                >
                            ...
                            <div className="mb-6">
                                ...
                                <input
                                    ...
                                    className="block w-full rounded-xl border-0 px-4 py-3 text-base shadow-sm ring-1 ring-gray-200 focus:ring-2 focus:ring-gray-400 focus:outline-none"
                                />
                            </div>
                            ...
                            <div className="flex gap-3">
                                <button
                                    onClick={closePopup}
                                    className="flex-1 rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-sm transition-colors hover:bg-gray-50"
                                >
                                    Abbrechen
                                </button>
                                <button
                                    onClick={handleAssignSubstitution}
                                    className="flex-1 rounded-xl border-2 border-gray-400 bg-white px-6 py-3 text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50 hover:border-gray-500 hover:shadow-md active:scale-95"
                                >
                                    Zuweisen
                                </button>
                            </div>
