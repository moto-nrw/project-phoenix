    ...
    <div className="border-b border-gray-100 last:border-b-0">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          {day.attendance && (
            <span className="bg-moto-green/10 rounded-full px-2 py-0.5 text-xs font-medium text-[#70b525]">
                  ...
                  return (
                    <React.Fragment key={day.date}>
                      ...
                      >
                        ...
                        <td className="px-6 py-3">
                          {day.attendance ? (
                            <span className="bg-moto-green/10 rounded-full px-2.5 py-0.5 text-xs font-medium text-[#70b525]">
                              {formatDuration(day.attendance.durationMinutes)}
                            </span>
                          ) : (
