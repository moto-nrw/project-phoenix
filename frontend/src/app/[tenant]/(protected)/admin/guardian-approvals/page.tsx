...
export default function GuardianApprovalsPage() {
  // Die Warteschlange liest das Backend mit users:manage; dasselbe Recht
  // zeigt den Eintrag in der Elterngruppe (#3469).
  const { isReady } = useRequirePermission("users:manage");
