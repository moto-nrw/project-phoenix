              ...
              >
                ...
                <div className="relative p-6">
                  <div className="mb-4 flex items-start justify-between">
                    <div className="rounded-2xl bg-gray-900 p-3 text-white shadow-sm transition-[background-color,box-shadow] duration-300 group-hover:bg-gray-800 group-hover:shadow-md">
