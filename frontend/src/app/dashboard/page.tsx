...
const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-gray-100/50 bg-white/90 shadow-[0_8px_30px_rgb(0,0,0,0.12)] backdrop-blur-md transition-all duration-300">
      <div
    ...
    <div className="relative p-4 md:p-6">
      <div className="mb-4 flex items-center justify-between">
        ...
        {href && (
          <Link
            href={href}
            className="flex items-center gap-1 text-xs font-medium text-gray-600 transition-colors hover:text-gray-900 md:text-sm"
          >
            <span>{linkText}</span>
            <svg
              className="h-4 w-4"
