    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto p-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <FeatureCard
            title="Raumübersicht"
            description="Aktuelle Belegung und Aktivitäten"
            href="/rooms"
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <FeatureCard
            title="Suche Kind"
            description="Kinderdaten finden"
          ...
          <FeatureCard
            title="Vertretungen"
            description="Pädagogische Fachkräfte ersetzen"
            href="/substitutions"
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <FeatureCard
            title="Passwörter"
            description="Passwörter zurücksetzen"
            href="/passwords"
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <FeatureCard
            title="Einstellungen"
            description="Anpassungen vornehmen"
            href="/settings"
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <FeatureCard
            title="Statistiken"
            description="Echtzeit-Schulmetriken"
            href="/metrics"
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
