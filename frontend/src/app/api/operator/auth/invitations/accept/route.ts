...
const logger = createLogger({ component: "OperatorInvitationAcceptRoute" });
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(
      `${getServerApiUrl()}/operator/auth/invitations/accept`,
      {
        method: "POST",
        headers: {
    ...
    logger.error("operator_invitation_accept_failed", {
