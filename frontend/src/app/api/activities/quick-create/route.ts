 ...
 */
export const POST = createPostHandler<QuickCreateActivityResponse, QuickCreateActivityRequest>(
  async (_request: NextRequest, body: QuickCreateActivityRequest, token: string) => {
    ...
    try {
      const response = await apiPost<ApiResponse<QuickCreateActivityResponse> | QuickCreateActivityResponse, QuickCreateActivityRequest>(
