...
src/app/[tenant]/(protected)/active-supervisions/page.tsx|bg-red-100:2 bg-red-50:2 border-red-200:2 text-red-600:2
src/app/[tenant]/(protected)/activities/page.tsx|bg-red-50 border-red-200 text-red-800
src/app/[tenant]/(protected)/dashboard/page.tsx|bg-red-50 border-red-200 text-red-800
...
src/app/[tenant]/(protected)/ogs-groups/page.tsx|bg-orange-50:2 border-orange-200:2 text-orange-600:2 text-orange-900
...
src/app/operator/announcements/page.tsx|bg-amber-100 bg-red-500 bg-red-600 border-blue-500:3 text-amber-700
...
src/app/operator/operators/page.tsx|bg-green-100 bg-red-100 bg-red-200 bg-red-50 bg-red-500 bg-red-600 bg-violet-100 bg-violet-200 border-red-200 border-violet-500:2 text-green-700 text-red-600:2 text-red-700:2 text-violet-700
src/app/operator/persons/page.tsx|bg-amber-50 bg-blue-50 bg-green-50 bg-purple-50 bg-red-50:2 bg-red-600 bg-red-700 border-red-500 text-amber-800 text-blue-700 text-green-700 text-purple-700 text-red-600:2
src/app/operator/provisioning/create-account-modal.tsx|bg-green-50 border-blue-500 text-blue-600 text-green-600 text-green-800
src/app/operator/provisioning/create-device-modal.tsx|bg-green-50 border-blue-500:3 border-green-200 text-blue-600:2 text-green-700 text-green-800
src/app/operator/provisioning/create-organization-modal.tsx|border-blue-500:2
src/app/operator/provisioning/create-school-modal.tsx|border-blue-500:8
src/app/operator/provisioning/edit-organization-modal.tsx|border-blue-500:2
src/app/operator/provisioning/edit-school-modal.tsx|border-blue-500:8
src/app/operator/provisioning/invite-admin-modal.tsx|bg-green-50 border-blue-500 text-blue-600 text-green-600 text-green-800 text-red-600
src/app/operator/provisioning/provisioning-shared.tsx|bg-amber-50 bg-blue-600 bg-green-100:2 bg-red-100 bg-red-50 bg-yellow-100 text-amber-700 text-green-700:2 text-red-500 text-red-600 text-red-700 text-yellow-700
src/app/operator/provisioning/set-api-key-modal.tsx|bg-amber-50 bg-green-50 bg-red-600 bg-red-700 border-amber-200 border-blue-500 border-green-200 text-amber-800 text-blue-600:2 text-green-800
src/app/operator/provisioning/soft-delete-shared.tsx|bg-amber-50 bg-green-100 bg-green-200 bg-red-100 bg-red-50:4 bg-red-50/50 bg-red-600 bg-red-700 border-red-100/50 border-red-500 text-amber-800 text-green-700 text-red-600:4 text-red-700
...
src/components/activities/activity-management-modal.tsx|border-red-200/30 text-red-600:2 text-red-700
src/components/activities/quick-create-modal.tsx|text-red-600:3
...
src/components/admin/invitation-form.tsx|bg-red-50/50 border-red-200/50 text-red-600:2 text-red-700
...
src/components/auth/invitation-accept-form.tsx|bg-red-50/50 border-red-200/50 text-red-600:5 text-red-700
...
src/components/auth/role-permission-management-modal.tsx|bg-purple-50:2 bg-purple-50/30 bg-purple-600:2 bg-purple-700 border-purple-400:2 text-purple-600:2
...
src/components/guardians/guardian-list.tsx|bg-blue-100 bg-green-100 bg-purple-100:2 bg-red-100 text-blue-600:2 text-blue-800 text-green-800 text-purple-700 text-purple-800 text-red-800
src/components/guardians/guardian-picker-panel.tsx|bg-blue-50/40:2 bg-red-50 border-red-200 text-blue-600:2 text-red-800
src/components/guardians/guardian-relationship-fields.tsx|bg-blue-50/30 bg-red-50 border-red-200 text-blue-600 text-green-600 text-purple-600 text-red-600:2 text-red-900
...
src/components/import/upload-section.tsx|bg-green-50 border-green-500 text-green-500 text-green-600:2
...
src/components/settings/personalization-tab.tsx|bg-green-50 bg-red-50 border-green-500 border-red-200 text-green-500 text-red-600
...
src/components/students/pickup-day-edit-modal.tsx|bg-red-50:3 border-blue-500:3 border-red-200 text-red-500 text-red-600 text-red-700
src/components/students/pickup-schedule-form-modal.tsx|bg-red-50 border-blue-500:2 border-red-200 text-red-700
...
src/components/time-tracking/vacation-request-modal.tsx|bg-amber-200 bg-amber-50:2 bg-red-50 border-amber-200 border-red-200 text-amber-700 text-amber-800 text-red-600 text-red-700
...
src/components/ui/button.tsx|bg-green-600 bg-green-700 bg-red-100 bg-red-50 bg-red-600 bg-red-700 text-red-600
src/components/ui/database/accents.ts|border-amber-300 border-amber-500 border-blue-300 border-blue-500 border-green-300 border-green-500 border-indigo-300 border-indigo-500 border-orange-300 border-orange-500 border-pink-300 border-pink-500 border-purple-300 border-purple-500 border-red-300 border-red-500 border-yellow-300 border-yellow-500 text-amber-500 text-amber-600:2 text-blue-500 text-blue-600:2 text-green-500 text-green-600:2 text-indigo-500 text-indigo-600:2 text-orange-500 text-orange-600:2 text-pink-500 text-pink-600:2 text-purple-500 text-purple-600:2 text-red-500 text-red-600:2 text-yellow-500 text-yellow-600:2
...
src/components/ui/page-header/FilterButton.tsx|bg-blue-500:2 border-blue-500
src/components/ui/page-header/FilterPanel.tsx|bg-blue-50 text-blue-500 text-blue-700
src/components/ui/page-header/OverflowMenu.tsx|text-red-600
src/components/ui/page-header/PageHeader.tsx|bg-green-500 bg-red-500 bg-yellow-500
src/components/ui/page-header/PageHeaderWithSearch.tsx|bg-blue-50:2 text-blue-700:2
...
src/lib/database/themes.tsx|bg-amber-50 bg-blue-50 bg-green-50 bg-indigo-50 bg-orange-50 bg-purple-50 border-amber-200 border-blue-200 border-green-200 border-indigo-200 border-orange-200 border-purple-200 text-amber-800 text-blue-800 text-green-800 text-indigo-800 text-orange-800 text-purple-800 text-red-800
...
const BRAND_COLOR_RE =
  /\b(?:text|bg|border)-(?:red|orange|amber|yellow|lime|green|emerald|teal|cyan|sky|blue|indigo|violet|purple|fuchsia|pink|rose)-\d+(?:\/(?:\d+|\[[^\]\s]+\]))?(?![\w-])/g;
  ...
  create(context) {
    ...
    return {
      ...
      JSXAttribute(node) {
        ...
        const classExpression = chunks.join(" ");
        check(node, classExpression);
      },
    };
  },
};
