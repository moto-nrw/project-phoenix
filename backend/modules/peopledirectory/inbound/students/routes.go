...
// mountStudentReadRoutes registers the child list, detail, location, day log, history and absence reads.
func (rs *Resource) mountStudentReadRoutes(r chi.Router, withTx common.Middleware) {
...
// mountRequestQueueRoutes registers the aggregated parent request queue, its badge and its cross-kind commands, and the family protection flag.
func (rs *Resource) mountRequestQueueRoutes(r chi.Router, withTx common.Middleware) {
...
// mountStudentWriteRoutes registers the child writes: create, update, absence days, end of care and deletion.
func (rs *Resource) mountStudentWriteRoutes(r chi.Router, withTx common.Middleware) {
...
// mountPickupRoutes registers the privacy consent, the companions and the pickup schedules, exceptions, partial absences and notes.
func (rs *Resource) mountPickupRoutes(r chi.Router, withTx common.Middleware) {
...
// mountArrivalRoutes registers the arrival schedules, exceptions, notes and class arrival exceptions.
func (rs *Resource) mountArrivalRoutes(r chi.Router, withTx common.Middleware) {
...
// mountCheckinAndFileRoutes registers the web school check-in, the photo and the child documents.
func (rs *Resource) mountCheckinAndFileRoutes(r chi.Router, withTx common.Middleware) {
...
// mountDeviceRoutes registers the device-authenticated RFID tag routes.
func (rs *Resource) mountDeviceRoutes(r chi.Router) {
	r.Use(rs.requiredDeviceAuthenticator())
