...
func TestAttendanceExportRows_KeepSlotsAndExplicitUnassignedSession(t *testing.T) {
	...
	rows := attendanceExportRows([]*studentpresence.HistorySlot{
		{
			...
			Attendance: &studentpresence.HistorySlotAttendance{
				Status: studentpresence.SessionAttendancePresent, CheckedInAt: &morningCheckIn,
			},
		},
		{
			Instance: &studentpresence.HistorySlotInstance{
	...
	rows := attendanceExportRows([]*studentpresence.HistorySlot{
		{
			...
			Attendance: &studentpresence.HistorySlotAttendance{
				...
				Status: studentpresence.SessionAttendancePresent, CheckedInAt: &reentryCheckIn,
			},
		},
	}, []*studentpresence.Attendance{
	...
	rows := attendanceExportRows([]*studentpresence.HistorySlot{
		{
			...
			Attendance: &studentpresence.HistorySlotAttendance{
				Status: studentpresence.SessionAttendancePresent, CheckedInAt: &day2CheckIn,
			},
		},
		{
			Instance: &studentpresence.HistorySlotInstance{
			...
			Attendance: &studentpresence.HistorySlotAttendance{Status: studentpresence.SessionAttendanceAbsent},
		},
	}, []*studentpresence.Attendance{
