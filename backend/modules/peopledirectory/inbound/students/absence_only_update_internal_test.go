...
func TestIsAbsenceOnly(t *testing.T) {
	...
	cases := []struct {
		...
		{"sick plus departure plan", &UpdateStudentRequest{Sick: boolPtr(true), AllowedDepartureModes: &departure.AllowedDepartureModes{"monday": {departure.DepartureAlone}}}, false},
