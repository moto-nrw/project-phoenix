	...
	students := []StudentResponse{
		{
			...
			AllowedDepartureModes:   departure.AllowedDepartureModes{departure.PickupDayMonday: {departure.DepartureAlone}},
		...
		},
		{
			...
			AllowedDepartureModes:   departure.AllowedDepartureModes{departure.PickupDayMonday: {departure.DeparturePickup}},
			DepartureRuleConfigured: true,
			HasFullAccess:           true,
		},
		{
