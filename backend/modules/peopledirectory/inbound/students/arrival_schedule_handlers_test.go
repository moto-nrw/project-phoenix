...
func TestGetStudentArrivalSchedules(t *testing.T) {
	...
	t.Run("success_returns_schedules_with_data", func(t *testing.T) {
		...
		testpkg.InsertStudentArrivalScheduleRow(t, tc.db, testpkg.StudentArrivalScheduleRow{
		...
		defer func() {
			_, _ = tc.db.NewDelete().TableExpr("schedule.student_arrival_schedules").
		...
		testpkg.InsertStudentArrivalExceptionRow(t, tc.db, testpkg.StudentArrivalExceptionRow{
			TenantID:        testpkg.Tenant(t),
			StudentID:       studentWithData.ID,
		...
		defer func() {
			_, _ = tc.db.NewDelete().TableExpr("schedule.student_arrival_exceptions").
				Where("student_id = ?", studentWithData.ID).
				Exec(context.Background())
		}()
...
func TestUpdateStudentArrivalSchedules(t *testing.T) {
	...
	t.Run("success_empty_schedules_clears_existing", func(t *testing.T) {
		...
		count, err := tc.db.NewSelect().TableExpr("schedule.student_arrival_schedules").
			Where("student_id = ?", student.ID).
...
func TestCreateStudentArrivalException(t *testing.T) {
	...
	t.Run("create_over_guardian_row_reclaims_for_staff", func(t *testing.T) {
		...
		testpkg.InsertStudentArrivalExceptionRow(t, tc.db, testpkg.StudentArrivalExceptionRow{
			...
			Source:            careplan.ExceptionSourceGuardian,
		...
		assert.Contains(t, rr.Body.String(), careplan.ExceptionSourceStaff)
		...
		assert.Equal(t, careplan.ExceptionSourceStaff, source)
	...
	t.Run("create_over_staff_row_conflicts", func(t *testing.T) {
		...
		testpkg.InsertStudentArrivalExceptionRow(t, tc.db, testpkg.StudentArrivalExceptionRow{
			...
			Reason:          &originalReason,
			Source:          careplan.ExceptionSourceStaff,
...
func TestUpdateStudentArrivalException(t *testing.T) {
	...
	t.Run("success_updates_exception", func(t *testing.T) {
		...
		exception := testpkg.InsertStudentArrivalExceptionRow(t, tc.db, testpkg.StudentArrivalExceptionRow{
			TenantID:        testpkg.Tenant(t),
			StudentID:       student.ID,
			ExceptionDate:   exceptionDate,
			ExpectedArrival: &exceptionTime,
...
func TestCreateStudentArrivalNote(t *testing.T) {
	...
	t.Run("success_creates_note", func(t *testing.T) {
		...
		// Cleanup
		_, _ = tc.db.NewDelete().TableExpr("schedule.student_arrival_notes").
			Where("student_id = ?", student.ID).
			Exec(context.Background())
	})
...
func TestUpdateStudentArrivalNote(t *testing.T) {
	...
	t.Run("success_updates_note", func(t *testing.T) {
		...
		note := testpkg.InsertStudentArrivalNoteRow(t, tc.db, testpkg.StudentDatedNoteRow{
			TenantID:  testpkg.Tenant(t),
			StudentID: student.ID,
			NoteDate:  noteDate,
