...
func fullyPopulatedStudentResponse() StudentResponse {
	...
	return StudentResponse{
		...
		PickupDays:               departure.PickupDays{"mon": true},
		...
		DepartureDays:            departure.DepartureDays{"mon": "pickup"},
		AllowedDepartureModes:    departure.AllowedDepartureModes{"mon": {"pickup"}},
		...
		Bus:                      true,
		BusDays:                  departure.BusDays{"mon": true},
		Sick:                     true,
		SickSince:                &now,
		Excused:                  true,
		ExcusedSince:             &now,
...
func TestSlimStudentResponseCopiesValues(t *testing.T) {
	...
	assert.Equal(t, []departure.DepartureMode{departure.DeparturePickup}, got.DepartureModes)
