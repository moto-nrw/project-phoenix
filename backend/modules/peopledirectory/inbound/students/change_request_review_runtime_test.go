...
func TestRequestReviewRuntimeEvidence(t *testing.T) {
	...
	seedChild := func(t *testing.T, n int) {
		...
		for i, status := range []string{"approved", "rejected"} {
