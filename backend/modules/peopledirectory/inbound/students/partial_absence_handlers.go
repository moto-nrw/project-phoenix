...
func (rs *Resource) requirePartialAbsenceWriteAccess(w http.ResponseWriter, r *http.Request, action string) *Student {
...
var partialAbsenceErrorRenderer = common.RulesRenderer([]common.ErrorRule{
	...
	{Match: common.IsNotFound, Render: partialAbsenceNotFound},
