...
func TestListStudents_DayPlanningForDate(t *testing.T) {
	...
	// requested Tuesday.
	testpkg.CreateTestPickupSchedule(t, tc.db, plannedMondayOnly.ID, 1, staff.ID, "15:30")        // Monday
	testpkg.CreateTestPickupSchedule(t, tc.db, plannedTomorrow.ID, 2, staff.ID, "15:30")          // Tuesday
	testpkg.CreateTestPickupSchedule(t, tc.db, sickTodayPlannedTomorrow.ID, 2, staff.ID, "14:00") // Tuesday
