...
func TestOffboardingMembershipSerializesConcurrentAssignmentCreation(t *testing.T) {
	...
	offboarding, err := NewOffboarding(Dependencies{DB: db, Observe: func(Observation) {}, Employment: testEmployment})
...
func TestOffboardingMembershipRetirementRollsBackWithOuterWorkflow(t *testing.T) {
	...
	db := testpkg.SetupTestDB(t)
	ctx := testpkg.Ctx(t)
	dependencies := Dependencies{DB: db, Observe: func(Observation) {}, Employment: testEmployment}
