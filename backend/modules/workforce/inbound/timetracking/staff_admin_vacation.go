...
func (rs *StaffAdminResource) setVacationOpening(w http.ResponseWriter, r *http.Request) {
	...
	opening, err := rs.StaffAbsenceService.SetVacationOpening(r.Context(), staffID, decidedBy, workforce.SetVacationOpeningRequest{
...
func (rs *StaffAdminResource) deleteVacationOpening(w http.ResponseWriter, r *http.Request) {
	staffID, err := common.ParseID(r)
	if err != nil {
		common.RenderError(w, r, common.ErrorInvalidRequest(err))
		return
