...
var balanceAdjustmentErrorRules = []common.ErrorRule{
	{Target: workforce.ErrAdjustmentInvalid, Render: common.ErrorInvalidRequest},
	{Target: workforce.ErrAdjustmentNotFound, Render: common.ErrorNotFound},
}
...
func (rs *StaffAdminResource) listBalanceAdjustments(w http.ResponseWriter, r *http.Request) {
	...
	adjustments, err := rs.BalanceAdjustService.ListAdjustments(r.Context(), staffID, from.String(), to.String())
	if err != nil {
...
func (rs *StaffAdminResource) createBalanceAdjustment(w http.ResponseWriter, r *http.Request) {
	...
	adjustment, err := rs.BalanceAdjustService.CreateAdjustment(r.Context(), staffID, decidedBy, workforce.CreateBalanceAdjustmentRequest{
		Type:          req.Type,
...
func (rs *StaffAdminResource) createOpeningBalance(w http.ResponseWriter, r *http.Request) {
	...
	adjustment, err := rs.BalanceAdjustService.CreateOpeningBalance(r.Context(), staffID, decidedBy, effectiveDate.String(), *req.BalanceMinutes, req.Note)
	if err != nil {
		tenant.MarkRollback(r.Context())
		renderBalanceAdjustmentError(w, r, err)
		return
...
func (rs *StaffAdminResource) resetStaffBalance(w http.ResponseWriter, r *http.Request) {
	...
	adjustment, err := rs.BalanceAdjustService.ResetBalance(r.Context(), staffID, decidedBy, effectiveDate.String(), req.CarryoverMinutes, req.Note)
	if err != nil {
		tenant.MarkRollback(r.Context())
		renderBalanceAdjustmentError(w, r, err)
		return
