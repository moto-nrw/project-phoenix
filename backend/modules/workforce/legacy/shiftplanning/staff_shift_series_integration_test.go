...
type seriesTestEnv struct {
	...
	series         shiftplanning.StaffShiftSeriesService
	shifts         shiftplanning.StaffShiftService
...
func TestStaffShiftSeries_CreateMaterializesFromTomorrow(t *testing.T) {
	...
	var result *shiftplanning.SeriesResult
...
func TestStaffShiftSeries_WeekPatternRequiresCycle(t *testing.T) {
	...
	require.ErrorIs(t, err, shiftplanning.ErrSeriesInvalid)
}
...
func TestStaffShiftSeries_SplitOutsideSegmentRejected(t *testing.T) {
	...
	err := env.inTxExpectErr(t, func(ctx context.Context) error {
		_, err := env.series.SplitSeries(ctx, shiftplanning.SplitSeriesInput{
			SeriesID:      series.ID,
	...
	require.ErrorIs(t, err, shiftplanning.ErrSeriesNotFound)
}
...
func TestStaffShiftSeries_SplitTodayUpdatesOccurrenceAndReplansTomorrow(t *testing.T) {
	...
	env.inTx(t, func(ctx context.Context) error {
		var err error
		result, err = env.series.SplitSeries(ctx, shiftplanning.SplitSeriesInput{
			SeriesID:          series.ID,
			EffectiveDate:     today,
	...
	var secondResult *shiftplanning.SeriesResult
	env.inTx(t, func(ctx context.Context) error {
		var err error
		secondResult, err = env.series.SplitSeries(ctx, shiftplanning.SplitSeriesInput{
...
func TestStaffShiftSeries_MoveConsumesOriginalDateBeforeRematerialization(t *testing.T) {
	...
	env.inTx(t, func(ctx context.Context) error {
		_, err := env.shifts.MoveShift(ctx, shiftplanning.MoveShiftInput{
			ShiftID:       original.ID,
...
func TestStaffShiftSeries_RepeatedMoveKeepsOriginalOccurrenceIdentity(t *testing.T) {
	...
	var splitResult *shiftplanning.SeriesResult
	env.inTx(t, func(ctx context.Context) error {
		var err error
		splitResult, err = env.series.SplitSeries(ctx, shiftplanning.SplitSeriesInput{
			SeriesID:      series.ID,
