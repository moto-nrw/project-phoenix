...
func WithStaffShiftSeriesExceptions(repo scheduleModels.StaffShiftSeriesExceptionRepository) StaffShiftOption {
...
func NewStaffShiftService(repo scheduleModels.StaffShiftRepository, staffRepo usersModels.StaffRepository, shiftTypes ShiftTypeService, db *bun.DB, logger *slog.Logger, opts ...StaffShiftOption) StaffShiftService {
	service := &staffShiftService{repo: repo, staffRepo: staffRepo, shiftTypes: shiftTypes, db: db, logger: logger}
