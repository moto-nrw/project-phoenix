...
type PlanningDependencies struct {
	...
	Series     StaffShiftSeriesService
...
func (p staffShiftPlanning) UpdateShift(ctx context.Context, input workforce.UpdateStaffShift) (workforce.PlannedShift, error) {
	...
	updated, err := p.deps.Shifts.UpdateShiftWithOptions(ctx, shift, StaffShiftUpdateOptions{
...
func (p staffShiftPlanning) MoveShift(ctx context.Context, input workforce.MoveStaffShift) (workforce.PlannedShift, error) {
	...
	moved, err := p.deps.Shifts.MoveShift(ctx, MoveShiftInput{
...
func (p staffShiftPlanning) ApplyCancellation(ctx context.Context, input workforce.CancelStaffShift) (workforce.StaffShiftCancellation, error) {
	...
	for _, replacement := range input.Replacements {
		...
		request.Replacements = append(request.Replacements, ShiftReplacementInput{
...
func (p staffShiftPlanning) SplitSeries(ctx context.Context, input workforce.SplitStaffShiftSeries) (workforce.StaffShiftSeriesResult, error) {
	...
	result, err := p.deps.Series.SplitSeries(ctx, SplitSeriesInput{
...
func seriesResultToCapability(result *SeriesResult) workforce.StaffShiftSeriesResult {
	if result == nil {
...
func overviewToCapability(overview *StaffScheduleOverview) workforce.StaffScheduleOverview {
	if overview == nil {
...
var planningErrorKinds = []struct {
	...
	{ErrShiftConflict, workforce.ErrStaffShiftConflict},
	{ErrShiftNotFound, workforce.ErrStaffShiftNotFound},
	{ErrShiftRangeTooLarge, workforce.ErrStaffShiftRangeTooLarge},
	{ErrShiftInvalid, workforce.ErrInvalidStaffShift},
	{ErrShiftTypeNotFound, workforce.ErrShiftTypeNotFound},
	{ErrShiftTypeInactive, workforce.ErrShiftTypeInactive},
	{ErrSeriesNotFound, workforce.ErrShiftSeriesNotFound},
	{ErrSeriesInvalid, workforce.ErrInvalidShiftSeries},
}
