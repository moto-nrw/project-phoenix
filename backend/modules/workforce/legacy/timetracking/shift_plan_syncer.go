...
// schedule.instance_staff). The port lives with the absence service; the
// schedule-owned implementation is bound by the composition root through
// WithAbsenceShiftPlanSyncer, mirroring the AttendanceSyncer
