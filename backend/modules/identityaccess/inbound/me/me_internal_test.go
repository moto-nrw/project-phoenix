// Package me internal tests for pure helper functions.
// These tests verify logic that doesn't require database access.
//
// Upload helper tests (detectContentType, CloseFile, etc.) live in api/common/.
package me
...
func TestNewResource_ReturnsResource(t *testing.T) {
	...
	resource := NewResource(identityaccess.CallerContext{}, nil)
