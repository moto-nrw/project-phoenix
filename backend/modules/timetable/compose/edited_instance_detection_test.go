...
func TestDiffOccurrence_Title(t *testing.T) {
	...
	assert.Equal(t, []string{timetable.EditedChangeTitle}, changes)
}
...
func TestDiffOccurrence_Notes(t *testing.T) {
	...
	inst.Notes = &note
	changes := edDiff(inst, edPristineStaff(), edPristineStudents(), edExpected())
	assert.Equal(t, []string{timetable.EditedChangeNotes}, changes)
}
...
func TestDiffOccurrence_Description(t *testing.T) {
	...
	changes := edDiff(inst, edPristineStaff(), edPristineStudents(), edExpected())
	assert.Equal(t, []string{timetable.EditedChangeDescription}, changes)
}
...
func TestDiffOccurrence_Room(t *testing.T) {
	...
	inst.RoomID = edRoomB
	changes := edDiff(inst, edPristineStaff(), edPristineStudents(), edExpected())
	assert.Equal(t, []string{timetable.EditedChangeRoom}, changes)
}
...
func TestDiffOccurrence_EndTimeChange(t *testing.T) {
	...
	changes := edDiff(inst, edPristineStaff(), edPristineStudents(), edExpected())
	assert.Equal(t, []string{timetable.EditedChangeTime}, changes)
}
...
func TestExpectedSlotsOn_LegacyWeekendScheduleIsNotMaterializable(t *testing.T) {
	...
	projection := &templateProjection{
		roster: templateRoster{schedules: []*activities.Schedule{{Weekday: 6}}},
	}
	saturday := timezone.NewDate(2026, time.June, 13)

	slots := projection.expectedSlotsOn(&activities.Group{}, nil, saturday)
...
func TestDiffOccurrence_StaffAdded(t *testing.T) {
	...
	assert.Equal(t, []string{timetable.EditedChangeStaff}, changes)
}
...
func TestDiffOccurrence_StudentsChanged(t *testing.T) {
	...
	assert.Equal(t, []string{timetable.EditedChangeStudents}, changes)
}
...
func TestDiffOccurrence_ManualPresentIsAttendanceEdit(t *testing.T) {
	...
	changes := edDiff(inst, edPristineStaff(), students, edExpected())
	assert.Equal(t, []string{timetable.EditedChangeAttendance}, changes)
}
...
func TestDiffOccurrence_MultipleChangesSorted(t *testing.T) {
	...
	inst.Notes = &note
	changes := edDiff(inst, edPristineStaff(), edPristineStudents(), edExpected())
	assert.Equal(t, []string{timetable.EditedChangeNotes, timetable.EditedChangeRoom, timetable.EditedChangeTitle}, changes,
