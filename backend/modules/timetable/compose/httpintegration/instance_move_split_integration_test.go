...
// The single-week edit is the instance lifecycle's (UpdatePlanned, #3424
// slice S1); the split, the full-series edit and the materialization are
// the template writes' (slice S2). This suite pins how they meet.
