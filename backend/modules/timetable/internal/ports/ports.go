...
type Store interface {
	...
	DeletePickupDayExtensionTask(context.Context, int64, string) (domain.OperationStats, error)
	DeletePickupWeekdayExtensionTask(context.Context, int64, int) (domain.OperationStats, error)
	DeletePastPickupExtensionTasks(context.Context, string) (domain.OperationStats, error)
	ListPickupExtensionTasks(context.Context, int64, string) ([]domain.PickupExtensionTask, domain.OperationStats, error)
	...
	ListPickupExtensionWeekdayBlocks(context.Context, []domain.PickupExtensionTask) ([]domain.PickupExtensionBlock, domain.OperationStats, error)
	ListPickupExtensionTemplateInstances(context.Context, int64, int64, int, string) ([]domain.PickupExtensionInstance, domain.OperationStats, error)
