...
type Store interface {
	...
	CountPlannedRosterForCareExit(context.Context, []int64, string) (map[int64]int, domain.OperationStats, error)
	CountRestorableRosterForCareExit(context.Context, []int64, string, []domain.CareExitRosterRow) (map[int64]int, domain.OperationStats, error)
