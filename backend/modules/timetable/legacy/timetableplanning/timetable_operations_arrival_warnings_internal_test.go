...
func TestAppendArrivalWarningsAddsTheClassExceptionLine(t *testing.T) {
	...
	appendArrivalWarnings(warnings, map[int64]*scheduleSvc.EffectiveArrivalTime{
		1: {ArrivalTime: &clock, ClassException: &scheduleSvc.ClassArrivalExceptionInfo{
...
func TestAppendArrivalWarningsKeepsOnlyTheReasonWhenTheClassArrivesLate(t *testing.T) {
	...
	appendArrivalWarnings(warnings, map[int64]*scheduleSvc.EffectiveArrivalTime{
		1: {ArrivalTime: &late, ClassException: &scheduleSvc.ClassArrivalExceptionInfo{
