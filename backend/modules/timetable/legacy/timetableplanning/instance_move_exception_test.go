...
func moveInput(s *scenarioSetup, inst *scheduleModels.ActivityInstance, date timezone.Date, startShiftHours int) timetableplanning.UpdateInstanceInput {
	return timetableplanning.UpdateInstanceInput{
		Date:            date,
