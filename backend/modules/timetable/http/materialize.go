...
type materializeResponse struct {
	...
	SkippedHolidays             int                  `json:"skipped_holidays"`
	SkippedClosingDays          int                  `json:"skipped_closing_days"`
...
func (rs *Resource) materialize(w http.ResponseWriter, r *http.Request) {
	...
	common.Respond(w, r, http.StatusOK, newMaterializeResponse(result), "Materialization completed")
}

// newMaterializeResponse maps a materialization run onto the wire shape.
func newMaterializeResponse(result *timetableModule.MaterializationResult) materializeResponse {
	...
	return materializeResponse{
		...
		SkippedHolidays:             result.CandidatesSkippedHoliday,
		SkippedClosingDays:          result.CandidatesSkippedClosingDay,
