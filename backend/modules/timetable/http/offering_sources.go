// Package timetablehttp — GET /api/timetable/offering-sources handler (#2137).
//
...
// offeringSourceOptionResponse mirrors timetable.OfferingSourceOption with
...
// timetable.OfferingSourceCounts with string-keyed grade counts.
