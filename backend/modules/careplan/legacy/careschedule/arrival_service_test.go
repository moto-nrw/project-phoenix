...
func setupArrivalScheduleService(t *testing.T, db *bun.DB) careschedule.ArrivalScheduleService {
...
func TestArrivalScheduleService_BulkUpsertArrivalSchedules(t *testing.T) {
	...
	t.Run("returns error without a filter", func(t *testing.T) {
		result, err := service.BulkUpsertArrivalSchedules(ctx, careschedule.ArrivalScheduleBulkFilter{}, []careschedule.ArrivalScheduleInput{
	...
	t.Run("returns error with class and group filters", func(t *testing.T) {
		result, err := service.BulkUpsertArrivalSchedules(ctx, careschedule.ArrivalScheduleBulkFilter{
			SchoolClass: "1a",
			GroupID:     42,
		}, []careschedule.ArrivalScheduleInput{
			{Weekday: 1, ArrivalTime: "08:00"},
		}, createArrivalServiceTestStaffID(t, db))
	...
	t.Run("upserts schedules only for explicitly selected students", func(t *testing.T) {
		...
		result, err := service.BulkUpsertArrivalSchedules(
			ctx,
			careschedule.ArrivalScheduleBulkFilter{StudentIDs: []int64{selectedA.ID, selectedB.ID}},
			[]careschedule.ArrivalScheduleInput{{Weekday: 4, ArrivalTime: "10:05"}},
			createArrivalServiceTestStaffID(t, db),
		)
	...
	t.Run("rejects the whole explicit selection when one student is unauthorized", func(t *testing.T) {
		...
		result, err := service.BulkUpsertArrivalSchedules(
			...
			[]careschedule.ArrivalScheduleInput{{Weekday: 1, ArrivalTime: "08:40"}},
			createArrivalServiceTestStaffID(t, db),
		)

		require.ErrorIs(t, err, careschedule.ErrBulkStudentUnauthorized)
		assert.Nil(t, result)
	...
	t.Run("returns error for empty schedules", func(t *testing.T) {
		result, err := service.BulkUpsertArrivalSchedules(ctx, careschedule.ArrivalScheduleBulkFilter{SchoolClass: "1a"}, []careschedule.ArrivalScheduleInput{}, createArrivalServiceTestStaffID(t, db))
	...
	t.Run("returns zero students affected for empty class", func(t *testing.T) {
		result, err := service.BulkUpsertArrivalSchedules(ctx, careschedule.ArrivalScheduleBulkFilter{SchoolClass: "NONEXISTENT_CLASS_XYZ"}, []careschedule.ArrivalScheduleInput{
			{Weekday: 1, ArrivalTime: "08:00"},
		}, createArrivalServiceTestStaffID(t, db))
	...
	t.Run("sets the class timetable without inventing care days", func(t *testing.T) {
		...
		schedules := []careschedule.ArrivalScheduleInput{
			{Weekday: 1, ArrivalTime: "07:45"},
			{Weekday: 3, ArrivalTime: "08:15"},
		}

		result, err := service.BulkUpsertArrivalSchedules(ctx, careschedule.ArrivalScheduleBulkFilter{SchoolClass: className}, schedules, staffID)
	...
	t.Run("skips children whose care has ended instead of failing the class", func(t *testing.T) {
		...
		schedules := []careschedule.ArrivalScheduleInput{{Weekday: 1, ArrivalTime: "07:45"}}
		result, err := service.BulkUpsertArrivalSchedules(
			ctx,
			careschedule.ArrivalScheduleBulkFilter{SchoolClass: className},
			schedules,
			staffID,
		)
	...
	t.Run("upserts schedules only for students in the selected group", func(t *testing.T) {
		...
		result, err := service.BulkUpsertArrivalSchedules(
			ctx,
			careschedule.ArrivalScheduleBulkFilter{GroupID: targetGroup.ID},
			[]careschedule.ArrivalScheduleInput{{Weekday: 2, ArrivalTime: "09:15"}},
			createArrivalServiceTestStaffID(t, db),
		)
	...
	t.Run("preserves an own time when the class time changes", func(t *testing.T) {
		...
		result, err := service.BulkUpsertArrivalSchedules(ctx, careschedule.ArrivalScheduleBulkFilter{SchoolClass: className}, schedules, createArrivalServiceTestStaffID(t, db))
