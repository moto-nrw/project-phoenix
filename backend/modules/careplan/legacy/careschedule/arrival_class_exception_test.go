...
func arrivalServiceWithClassExceptions(t *testing.T, repos *repositories.Factory) careschedule.ArrivalScheduleService {
	t.Helper()
...
func TestUpsertClassArrivalExceptionWritesAndListsOneRowPerDate(t *testing.T) {
	...
	first, err := svc.UpsertClassArrivalException(ctx, careschedule.ClassArrivalExceptionInput{
		SchoolClass: " 2b ",
		Date:        monday,
	...
	_, err = svc.UpsertClassArrivalException(ctx, careschedule.ClassArrivalExceptionInput{
		SchoolClass: "2b",
		Date:        monday,
	...
	assert.True(t, errors.Is(err, careschedule.ErrClassArrivalExceptionNotFound))
}
...
func TestUpsertClassArrivalExceptionReturnsPersistedMetadata(t *testing.T) {
	...
	created, err := svc.UpsertClassArrivalException(ctx, careschedule.ClassArrivalExceptionInput{
		SchoolClass: "2c",
		Date:        monday,
		ArrivalTime: time.Date(2000, 1, 1, 14, 15, 0, 0, time.UTC),
	}, staff.ID)
	...
	updated, err := svc.UpsertClassArrivalException(ctx, careschedule.ClassArrivalExceptionInput{
		SchoolClass: "2c",
		Date:        monday,
		ArrivalTime: time.Date(2000, 1, 1, 11, 45, 0, 0, time.UTC),
	}, staff.ID)
...
func TestUpsertClassArrivalExceptionRefusesPastDatesAndEmptyClasses(t *testing.T) {
	...
	assert.True(t, errors.Is(err, careschedule.ErrClassArrivalExceptionPastDate), "got %v", err)
	...
	assert.True(t, errors.Is(err, careschedule.ErrClassArrivalExceptionClassNotFound), "got %v", err)
	...
	assert.True(t, errors.Is(err, careschedule.ErrClassArrivalExceptionWeekend), "got %v", err)
