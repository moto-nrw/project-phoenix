...
func careServiceWithCoGuardianEmitter(t *testing.T, f *careFixture, sharedWith []int64) careschedule.CareScheduleRequestService {
	t.Helper()
	...
	return careschedule.NewCareScheduleRequestServiceWithPickupChangesAndPolicy(
		...
		careschedule.WithRequestShareVisibility(staticShareVisibility{recipients: sharedWith}),
	)
}
