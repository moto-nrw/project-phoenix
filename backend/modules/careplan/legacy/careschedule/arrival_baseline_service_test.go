...
func classArrivalBaseline(t *testing.T, repos *repositories.Factory) careschedule.ArrivalBaselineReader {
	t.Helper()
...
func approvedOfferingProjection(t *testing.T) careschedule.ApprovedBookingReader {
	t.Helper()
