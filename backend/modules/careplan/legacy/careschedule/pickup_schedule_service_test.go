...
func setupPickupScheduleService(t *testing.T, db *bun.DB) careschedule.PickupScheduleService {
...
func TestPickupScheduleService_ReclaimGuardianPickupRejectsSharedPartialAbsence(t *testing.T) {
	...
	partial, err := serviceFactory.PartialAbsence.Create(ctx, careschedule.PartialAbsenceInput{
		StudentID: student.ID,
		Date:      date,
	...
	require.ErrorIs(t, err, careschedule.ErrCareExceptionContainsPartialAbsence)
...
func TestPickupScheduleService_DeleteStudentPickupException(t *testing.T) {
	...
	t.Run("deletes exception by ID", func(t *testing.T) {
		...
		err = service.DeleteStudentPickupException(ctx, exception.ID)
		require.ErrorIs(t, err, careschedule.ErrCareExceptionNotFound,
...
func TestPickupScheduleService_BulkUpsertPickupSchedules(t *testing.T) {
	...
	result, err := service.BulkUpsertPickupSchedules(
		ctx,
		careschedule.ArrivalScheduleBulkFilter{StudentIDs: []int64{studentA.ID, studentB.ID}},
		[]careschedule.PickupScheduleInput{{Weekday: scheduleModels.WeekdayMonday, PickupTime: "16:10"}},
...
func TestPickupScheduleService_BulkUpsertPickupSchedules_RollsBackUnauthorizedSelection(t *testing.T) {
	...
	result, err := service.BulkUpsertPickupSchedules(ctx, careschedule.ArrivalScheduleBulkFilter{
	...
	}, []careschedule.PickupScheduleInput{{Weekday: 1, PickupTime: "16:10"}}, createPickupServiceTestStaffID(t, db))
