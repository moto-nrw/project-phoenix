...
func historyItemByID(t *testing.T, f *careFixture, id int64) *careschedule.CareRequestHistoryItem {
	t.Helper()
...
func TestDecide_FreezesAltNeuDiffInHistory(t *testing.T) {
	...
	_, err := f.svc.Decide(ctx, careschedule.CareRequestDecideInput{
	...
	require.Equal(t, []careschedule.RequestDiffEntry{{
		Label:    "Montag · Abholzeit",
		Old:      "15:00",
		New:      "16:00",
		Weekday:  1,
		CareKind: careschedule.DiffCareKindPickup,
...
func TestDecide_SkipsSnapshotWhenPickupPlanReadFails(t *testing.T) {
	...
	_, err := rejectingService.Decide(f.staffCtx(f.staffAccount), careschedule.CareRequestDecideInput{
...
func TestListPending_FallsBackToRequestedWhenPickupPlanReadFails(t *testing.T) {
	...
	assert.Equal(t, []careschedule.RequestDiffEntry{{
		Label:    "Montag · Abholzeit",
		New:      "16:00",
		Weekday:  1,
		CareKind: careschedule.DiffCareKindPickup,
