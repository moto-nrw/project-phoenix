...
func setupPickupScheduleService(t *testing.T, db *bun.DB) careplan.PickupScheduleService {
...
func TestPickupScheduleService_UpsertBulkStudentPickupSchedules(t *testing.T) {
	...
	t.Run("creates multiple schedules in transaction", func(t *testing.T) {
		...
		schedules := []*careplan.PickupSchedule{
			{
				Weekday:    scheduleModels.WeekdayMonday,
				PickupTime: time.Date(2024, 1, 1, 14, 0, 0, 0, time.UTC),
				CreatedBy:  createPickupServiceTestStaffID(t, db),
...
func TestPickupScheduleService_CreateStudentPickupException(t *testing.T) {
	...
	t.Run("creates exception successfully", func(t *testing.T) {
		...
		exception := &careplan.PickupException{
			StudentID:     student.ID,
	...
	t.Run("upserts when exception already exists for date", func(t *testing.T) {
		...
		exception1 := &careplan.PickupException{
			StudentID:     student.ID,
		...
		exception2 := &careplan.PickupException{
			StudentID:     student.ID,
			ExceptionDate: careplan.Date(exceptionDate),
...
func TestPickupScheduleService_ReclaimGuardianPickupRejectsSharedPartialAbsence(t *testing.T) {
	...
	partial, err := serviceFactory.PartialAbsence.CreatePartialAbsence(ctx, careplan.PartialAbsenceInput{
		StudentID: student.ID,
		Date:      date,
	...
	require.ErrorIs(t, err, careplan.ErrCareExceptionContainsPartialAbsence)
...
func TestPickupScheduleService_CreateExceptionUpsertDropsPartialOwnershipOnTimeChange(t *testing.T) {
	...
	override := &careplan.PickupException{
		StudentID:     student.ID,
		ExceptionDate: careplan.Date(exceptionDate),
...
func TestPickupScheduleService_DeleteStudentPickupException(t *testing.T) {
	...
	t.Run("deletes exception by ID", func(t *testing.T) {
		...
		err = service.DeleteStudentPickupException(ctx, exception.ID, exception.StudentID)
...
func TestPickupScheduleService_DeleteAllStudentPickupExceptions(t *testing.T) {
	...
	t.Run("rejects the batch when one exception owns a partial absence", func(t *testing.T) {
		...
		ordinary := &careplan.PickupException{
			StudentID:     student.ID,
			ExceptionDate: careplan.Date(date.AddDays(-1)),
		...
		from := timezone.NormalizeWallClock(time.Date(2000, 1, 1, 13, 30, 0, 0, time.UTC))
		partial := &careplan.PickupException{
			StudentID:             student.ID,
			ExceptionDate:         careplan.Date(date),
			PickupTime:            &from,
			ExcusedFrom:           &from,
...
func TestPickupScheduleService_GetBulkEffectivePickupTimesForDate(t *testing.T) {
	...
	t.Run("returns effective times for multiple students", func(t *testing.T) {
		...
		sched1 := &careplan.PickupSchedule{
		...
		exception3 := &careplan.PickupException{
...
func TestPickupScheduleService_BulkUpsertPickupSchedules(t *testing.T) {
	...
	note := "Oma holt ab"
	require.NoError(t, service.UpsertStudentPickupSchedule(ctx, &careplan.PickupSchedule{
	...
	result, err := service.BulkUpsertPickupSchedules(
		ctx,
		careplan.PickupBulkFilter{StudentIDs: []int64{studentA.ID, studentB.ID}},
		[]careplan.PickupScheduleInput{{Weekday: scheduleModels.WeekdayMonday, PickupTime: "16:10"}},
	...
	byWeekday := make(map[int]*careplan.PickupSchedule, len(rowsA))
...
func TestPickupScheduleService_BulkUpsertPickupSchedules_RollsBackUnauthorizedSelection(t *testing.T) {
	...
	result, err := service.BulkUpsertPickupSchedules(ctx, careplan.PickupBulkFilter{
	...
	}, []careplan.PickupScheduleInput{{Weekday: 1, PickupTime: "16:10"}}, createPickupServiceTestStaffID(t, db))
...
func TestPickupScheduleService_EffectiveTimeKeepsRegularTime(t *testing.T) {
	...
	t.Run("an exception keeps the regular time next to the new one", func(t *testing.T) {
		...
		require.NoError(t, service.CreateStudentPickupException(ctx, &careplan.PickupException{
			StudentID:     student.ID,
			ExceptionDate: careplan.Date(testDate),
			PickupTime:    &earlier,
