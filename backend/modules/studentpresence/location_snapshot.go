...
type StudentLocationSnapshot struct {
	...
	Groups      map[int64]*SessionDetail
...
func (s *StudentLocationSnapshot) resolveDetailedLocation(
	studentID int64, status *DailyAttendanceStatus, hasFullAccess bool,
) StudentLocationInfo {
...
func detailedAttendanceLocation(status *DailyAttendanceStatus, hasFullAccess bool) StudentLocationInfo {
...
func (s *StudentLocationSnapshot) resolveVisitLocation(visit *Visit) StudentLocationInfo {
...
func ResolveBinaryLocation(status *DailyAttendanceStatus, hasFullAccess bool) StudentLocationInfo {
...
func NewStudentLocationSnapshot(mode string) *StudentLocationSnapshot {
	...
	return &StudentLocationSnapshot{
		Mode:        mode,
		Attendances: make(map[int64]*DailyAttendanceStatus),
		Visits:      make(map[int64]*Visit),
		Groups:      make(map[int64]*SessionDetail),
	}
}
...
func ResolveYardRoomColor(ctx context.Context, svc any) *string {
