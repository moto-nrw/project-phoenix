...
// list: one open visit joined with the student's display data. It is the
// owner's public VisitDisplay.
type VisitWithStudentDisplay = studentpresence.VisitDisplay
