...
type AttendanceSyncer interface {
	...
	MirrorCheckInForVisit(ctx context.Context, visit *Visit) (*AttendanceSnapshot, error)
	...
	MirrorCheckOutForVisit(ctx context.Context, visit *Visit) (*AttendanceSnapshot, error)
	...
	MirrorVisitRevision(ctx context.Context, previous, updated *Visit) error
	...
	MirrorCheckOutForVisits(ctx context.Context, visits []*Visit, at time.Time) error
}
