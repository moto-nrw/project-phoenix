...
func buildGuardianService(t *testing.T) (*parentService.Portal, *bun.DB) {
...
func buildGuardianServiceFeature(t *testing.T, mgmtEnabled bool) (*parentService.Portal, *bun.DB) {
	t.Helper()
