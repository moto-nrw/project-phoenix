...
func careScheduleServiceWithSettings(t *testing.T, db *bun.DB, repos *repositories.Factory, boolValues map[string]bool, requestService ...*careschedule.CareScheduleRequestService) *care.Service {
	t.Helper()
