...
func TestEditedInWindow_Success(t *testing.T) {
	...
	mat := &mockMaterializationService{
		detectFn: func(activityGroupID int64, from, to timezone.Date, includeDeletions bool) ([]timetableModule.EditedOccurrence, error) {
...
func TestEditedInWindow_IncludeDeletionsForwarded(t *testing.T) {
	...
	var gotInclude bool
	mat := &mockMaterializationService{
		detectFn: func(_ int64, _, _ timezone.Date, includeDeletions bool) ([]timetableModule.EditedOccurrence, error) {
...
func TestEditedInWindow_EmptyResultIsArray(t *testing.T) {
	...
	mat := &mockMaterializationService{
		detectFn: func(_ int64, _, _ timezone.Date, _ bool) ([]timetableModule.EditedOccurrence, error) {
			return nil, nil
		},
	}
	rs := NewResource(Dependencies{MaterializationService: mat})
