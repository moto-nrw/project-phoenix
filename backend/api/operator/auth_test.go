...
func (m *mockOperatorAuthService) UpdateProfile(ctx context.Context, operatorID int64, displayName string, email string, clientIP net.IP) (*platform.Operator, error) {
	if m.updateProfileFn != nil {
		return m.updateProfileFn(ctx, operatorID, displayName, email, clientIP)
	}
	return nil, nil
}
