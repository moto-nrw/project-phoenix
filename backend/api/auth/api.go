...
func (rs *Resource) getRoleByID(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		common.RenderError(w, r, ErrorInvalidRequest(errors.New("invalid role ID")))
		return
	}
...
func (rs *Resource) assignRoleToAccount(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		common.RenderError(w, r, ErrorInvalidRequest(errors.New("invalid account ID")))
		return
	}
...
func (rs *Resource) getPermissionByID(w http.ResponseWriter, r *http.Request) {
	...
	id, err := strconv.Atoi(idStr)
	if err != nil {
		common.RenderError(w, r, ErrorInvalidRequest(errors.New("invalid permission ID")))
		return
	}
...
func (rs *Resource) getParentAccountByID(w http.ResponseWriter, r *http.Request) {
	...
	id, err := strconv.Atoi(idStr)
	if err != nil {
		common.RenderError(w, r, ErrorInvalidRequest(errors.New("invalid parent account ID")))
		return
	}
