...
func (req *DateframeRequest) Bind(r *http.Request) error {
...
func (req *TimeframeRequest) Bind(r *http.Request) error {
	return validation.ValidateStruct(req,
...
func (req *RecurrenceRuleRequest) Bind(r *http.Request) error {
	return validation.ValidateStruct(req,
...
func (req *GenerateEventsRequest) Bind(r *http.Request) error {
	return validation.ValidateStruct(req,
		validation.Field(&req.StartDate, validation.Required),
		validation.Field(&req.EndDate, validation.Required),
	)
...
func (req *CheckConflictRequest) Bind(r *http.Request) error {
	return validation.ValidateStruct(req,
		validation.Field(&req.StartTime, validation.Required),
...
func (req *FindAvailableSlotsRequest) Bind(r *http.Request) error {
	return validation.ValidateStruct(req,
		validation.Field(&req.StartDate, validation.Required),
		validation.Field(&req.EndDate, validation.Required),
...
func (rs *Resource) getDateframe(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		render.Render(w, r, ErrorInvalidRequest(errors.New("invalid dateframe ID")))
		return
	}
	...
	if err != nil {
		render.Render(w, r, ErrorNotFound(errors.New("dateframe not found")))
		return
	}
...
func (rs *Resource) createDateframe(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		render.Render(w, r, ErrorInvalidRequest(errors.New("invalid start date format")))
		return
	}

	endDate, err := time.Parse("2006-01-02", req.EndDate)
	if err != nil {
		render.Render(w, r, ErrorInvalidRequest(errors.New("invalid end date format")))
		return
	}
...
func (rs *Resource) getDateframesByDate(w http.ResponseWriter, r *http.Request) {
	...
	if dateStr == "" {
		render.Render(w, r, ErrorInvalidRequest(errors.New("date parameter is required")))
		return
	}
	...
	if err != nil {
		render.Render(w, r, ErrorInvalidRequest(errors.New("invalid date format")))
		return
	}
...
func (rs *Resource) getOverlappingDateframes(w http.ResponseWriter, r *http.Request) {
	...
	if startStr == "" || endStr == "" {
		render.Render(w, r, ErrorInvalidRequest(errors.New("start_date and end_date parameters are required")))
		return
	}
...
func (rs *Resource) getCurrentDateframe(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		render.Render(w, r, ErrorNotFound(errors.New("no current dateframe found")))
		return
	}
...
func (rs *Resource) getTimeframe(w http.ResponseWriter, r *http.Request) {
	...
	id, err := strconv.ParseInt(chi.URLParam(r, "id"), 10, 64)
	if err != nil {
		render.Render(w, r, ErrorInvalidRequest(errors.New("invalid timeframe ID")))
		return
	}
	...
	if err != nil {
		render.Render(w, r, ErrorNotFound(errors.New("timeframe not found")))
		return
	}
...
func (rs *Resource) createTimeframe(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		render.Render(w, r, ErrorInvalidRequest(errors.New("invalid start time format")))
		return
	}
	...
	if req.EndTime != nil {
		...
		if err != nil {
			render.Render(w, r, ErrorInvalidRequest(errors.New("invalid end time format")))
			return
		}
...
func (rs *Resource) getTimeframesByRange(w http.ResponseWriter, r *http.Request) {
	...
	if startStr == "" || endStr == "" {
		render.Render(w, r, ErrorInvalidRequest(errors.New("start_time and end_time parameters are required")))
		return
	}
...
func (rs *Resource) getRecurrenceRule(w http.ResponseWriter, r *http.Request) {
	...
	id, err := strconv.ParseInt(chi.URLParam(r, "id"), 10, 64)
	if err != nil {
		render.Render(w, r, ErrorInvalidRequest(errors.New("invalid recurrence rule ID")))
		return
	}
	...
	if err != nil {
		render.Render(w, r, ErrorNotFound(errors.New("recurrence rule not found")))
		return
	}
...
func (rs *Resource) getRecurrenceRulesByFrequency(w http.ResponseWriter, r *http.Request) {
	...
	frequency := r.URL.Query().Get("frequency")
	if frequency == "" {
		render.Render(w, r, ErrorInvalidRequest(errors.New("frequency parameter is required")))
		return
	}
...
func (rs *Resource) getRecurrenceRulesByWeekday(w http.ResponseWriter, r *http.Request) {
	...
	if weekday == "" {
		render.Render(w, r, ErrorInvalidRequest(errors.New("weekday parameter is required")))
		return
	}
