...
type fixtureSchoolGroups struct {
	...
	teachers func(context.Context, int64) ([]*users.Teacher, error)
}
...
func (f fixtureSchoolGroups) GetGroupTeachers(ctx context.Context, groupID int64) ([]*users.Teacher, error) {
