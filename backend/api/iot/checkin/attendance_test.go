...
// setupAttendanceTestContext initializes test database, services, and resource.
func setupAttendanceTestContext(t *testing.T) *attendanceTestContext {
	t.Helper()

	db, svc := testutil.SetupIoTAttendanceRoute(t)
