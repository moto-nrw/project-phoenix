...
func (rs *Resource) Router() chi.Router {
	...
	r.Group(func(r chi.Router) {
		...
		r.Route("/visits", func(r chi.Router) {
			...
			r.With(authorize.CombinePermissionAndResource(permissions.GroupsRead, "visit", policy.ActionView, authorize.URLParamExtractor("id"))).Get("/{id}", rs.getVisit)
...
func (rs *Resource) getActiveGroup(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		render.Render(w, r, ErrorInvalidRequest(errors.New("invalid active group ID")))
		return
	}
...
func (rs *Resource) getActiveGroupsByRoom(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		render.Render(w, r, ErrorInvalidRequest(errors.New("invalid room ID")))
		return
	}
...
func (rs *Resource) getVisit(w http.ResponseWriter, r *http.Request) {
	...
	id, err := strconv.ParseInt(chi.URLParam(r, "id"), 10, 64)
	if err != nil {
		render.Render(w, r, ErrorInvalidRequest(errors.New("invalid visit ID")))
		return
	}
...
func (rs *Resource) getSupervisor(w http.ResponseWriter, r *http.Request) {
	...
	id, err := strconv.ParseInt(chi.URLParam(r, "id"), 10, 64)
	if err != nil {
		render.Render(w, r, ErrorInvalidRequest(errors.New("invalid supervisor ID")))
		return
	}
...
func (rs *Resource) getCombinedGroup(w http.ResponseWriter, r *http.Request) {
	...
	id, err := strconv.ParseInt(chi.URLParam(r, "id"), 10, 64)
	if err != nil {
		render.Render(w, r, ErrorInvalidRequest(errors.New("invalid combined group ID")))
		return
	}
