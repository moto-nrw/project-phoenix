...
func newTestMFAService(t *testing.T, options ...services.AuthTestOption) (auth.MFAService, *repositories.Factory, *bun.DB) {
	t.Helper()
...
func newGatedAuthService(t *testing.T, db *bun.DB, mfa auth.MFAService) gatedAuthService {
	t.Helper()
