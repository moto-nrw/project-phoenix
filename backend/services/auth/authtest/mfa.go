...
type MFAServiceMock struct {
	...
	ResolveMFAPolicyFn             func(ctx context.Context, accountID, tenantID int64) (auth.MFAPolicy, error)
	ResolveMFAPolicyInTxFn         func(ctx context.Context, accountID, tenantID int64) (auth.MFAPolicy, error)
	...
	VerifyMFAChallengeFn           func(ctx context.Context, challengeToken, code string) (auth.VerifiedMFAChallenge, error)
	VerifyMFAChallengeForScopeFn   func(ctx context.Context, challengeToken, code, expectedScope string) (auth.VerifiedMFAChallenge, error)
	VerifyMFAChallengeForOwnerFn   func(ctx context.Context, challengeToken, code, expectedScope string, accountID, tenantID int64) (auth.VerifiedMFAChallenge, error)
	...
	ListTrustedDevicesFn           func(ctx context.Context, accountID, tenantID int64) ([]auth.AccountTrustedDevice, error)
	...
	GetMFAAdminStateFn             func(ctx context.Context, actorID, actorTenantID, targetAccountID int64, actorPermissions []string) (auth.MFAAdminState, error)
}

var _ auth.MFAService = (*MFAServiceMock)(nil)
...
// "MFA off".
func (m *MFAServiceMock) ResolveMFAPolicy(ctx context.Context, accountID, tenantID int64) (auth.MFAPolicy, error) {
...
func (m *MFAServiceMock) ResolveMFAPolicyInTx(ctx context.Context, accountID, tenantID int64) (auth.MFAPolicy, error) {
...
func (m *MFAServiceMock) VerifyMFAChallenge(ctx context.Context, challengeToken, code string) (auth.VerifiedMFAChallenge, error) {
	if m.VerifyMFAChallengeFn != nil {
		return m.VerifyMFAChallengeFn(ctx, challengeToken, code)
	}
	return auth.VerifiedMFAChallenge{}, nil
}
...
func (m *MFAServiceMock) VerifyMFAChallengeForScope(ctx context.Context, challengeToken, code, expectedScope string) (auth.VerifiedMFAChallenge, error) {
...
func (m *MFAServiceMock) VerifyMFAChallengeForOwner(ctx context.Context, challengeToken, code, expectedScope string, accountID, tenantID int64) (auth.VerifiedMFAChallenge, error) {
...
func (m *MFAServiceMock) ListTrustedDevices(ctx context.Context, accountID, tenantID int64) ([]auth.AccountTrustedDevice, error) {
...
func (m *MFAServiceMock) GetMFAAdminState(ctx context.Context, actorID, actorTenantID, targetAccountID int64, actorPermissions []string) (auth.MFAAdminState, error) {
	if m.GetMFAAdminStateFn != nil {
		return m.GetMFAAdminStateFn(ctx, actorID, actorTenantID, targetAccountID, actorPermissions)
	}
	return auth.MFAAdminState{}, nil
}
