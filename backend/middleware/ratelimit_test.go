...
func (m *mockSecurityLogger) LogRateLimitExceeded(_ *http.Request) {
	m.rateLimitCalls++
}

// Note: SecurityLogger might have more methods, but we only need LogRateLimitExceeded for this test
