...
func TestHubBroadcastToAllReachesAllClients(t *testing.T) {
	...
	hub.Register(clients[0], []string{"group_1"})
	hub.Register(clients[1], []string{"group_2"})
	hub.Register(clients[2], []string{}) // zero-topic client
...
func TestHubBroadcastToAllSkipsFullChannel(t *testing.T) {
	...
	hub.Register(fullClient, []string{})
	hub.Register(openClient, []string{})
