...
func QueueStaffTimeTrackingChanged(ctx context.Context, broadcaster Broadcaster, logger *slog.Logger) {
	if broadcaster == nil {
		return
	}
	...
	tenant.RegisterAfterCommit(ctx, func() {
		event := NewEvent(EventStaffTimeTrackingChanged, "", EventData{})
