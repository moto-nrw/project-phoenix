...
var moduleFuncLenAllowlist = map[string]int{
	...
	"modules/studentpresence/internal/application/presence/active_service.go:(*service).createVisit":                                      104,
	"modules/studentpresence/internal/application/presence/analytics_service.go:(*service).GetDashboardAnalytics":                         73,
	"modules/studentpresence/internal/application/presence/attendance_service.go:(*service).performCheckIn":                               103,
	"modules/studentpresence/internal/application/presence/attendance_service.go:(*service).performCheckOut":                              73,
	"modules/studentpresence/internal/application/presence/cleanup_service.go:(*cleanupService).CleanupStaleAttendance":                   72,
	"modules/studentpresence/internal/application/presence/dashboard_helpers.go:(*service).fetchDashboardBaseData":                        95,
	"modules/studentpresence/internal/application/presence/school_checkin_batch.go:(*service).processSchoolCheckinBatch":                  130,
	"modules/studentpresence/internal/application/presence/school_checkin_batch.go:(*service).registerSchoolCheckinBatchBroadcast":        67,
	"modules/studentpresence/internal/application/presence/session_service.go:(*service).executeSessionStart":                             69,
	"modules/studentpresence/internal/application/presence/student_status_day_write.go:(*StudentStatusDayService).BulkCreateForDates":     82,
	"modules/studentpresence/internal/application/presence/transit_service.go:(*service).assignTransitStudentsToActiveGroup":              110,
	"modules/studentpresence/internal/application/presence/transit_service.go:(*service).moveStudentsToActiveGroupLocked":                 169,
