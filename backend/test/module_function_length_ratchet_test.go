...
var moduleFuncLenAllowlist = map[string]int{
	...
	"modules/enrollment/form_schema.go:(*FormLegalBlock).Validate":                                                                        67,
	...
	"modules/enrollment/phase.go:(*Phase).Validate":                                                                                       141,
	...
	"modules/identityaccess/compose/new.go:New":                                                                                           79,
	...
	"modules/timetable/compose/httpadapter/activity_handlers.go:(*Resource).quickCreateActivity":                                          70,
	...
	"modules/timetable/legacy/timetableplanning/attendance_correction.go:(*TemplateService).CorrectInstanceStudentAttendance":             102,
	...
	"modules/timetable/legacy/timetableplanning/edited_instance_detection.go:(*materializationService).DetectEditedInWindow":              161,
	...
	"modules/timetable/legacy/timetableplanning/instance_series_conversion.go:(*TemplateService).templateAssignmentsOn":                   61,
	...
	"modules/timetable/legacy/timetableplanning/instance_service.go:(*instanceService).Start":                                             147,
	...
	"modules/timetable/legacy/timetableplanning/materialization_service.go:(*materializationService).materializeForTenantLocked":          89,
	"modules/timetable/legacy/timetableplanning/materialization_service.go:(*materializationService).materializeTemplate":                 163,
	...
	"modules/timetable/legacy/timetableplanning/template_create_service.go:(*TemplateService).createTemplateLocked":                       122,
	"modules/timetable/legacy/timetableplanning/template_create_service.go:validateOfferingSourceInput":                                   61,
	"modules/timetable/legacy/timetableplanning/template_series_roster.go:(*TemplateService).reconcilePredecessorEnrollmentRows":          68,
	"modules/timetable/legacy/timetableplanning/template_series_roster.go:(*TemplateService).reconcilePredecessorInstanceStaff":           108,
	"modules/timetable/legacy/timetableplanning/template_series_roster.go:(*TemplateService).reconcilePredecessorSegmentRoster":           86,
	"modules/timetable/legacy/timetableplanning/template_series_roster.go:(*TemplateService).reconcilePredecessorSupervisorRows":          88,
	...
	"modules/timetable/legacy/timetableplanning/template_update_service.go:(*TemplateService).replaceTemplateRoster":                      70,
	"modules/timetable/legacy/timetableplanning/template_update_service.go:(*TemplateService).updateTemplateLocked":                       123,
	...
	"modules/workforce/internal/planning/staff_shift_series_service.go:(*staffShiftSeriesService).materializeSeries":                      104,
	"modules/workforce/internal/planning/staff_shift_cancellation.go:(*staffShiftService).ApplyCancellation":                              223,
	"modules/workforce/internal/planning/staff_shift_service.go:(*staffShiftService).updateShiftWithOptions":                              148,
