...
var moduleFuncLenAllowlist = map[string]int{
	...
	"modules/timetable/legacy/timetableplanning/attendance_correction.go:(*AttendanceCorrectionService).CorrectInstanceStudentAttendance": 102,
	...
	"modules/timetable/legacy/timetableplanning/instance_series_conversion.go:(*instanceSeriesConversionService).ConvertInstanceToSeries": 90,
