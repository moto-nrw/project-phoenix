...
var handlerComplexityAllowlist = map[string]int{
	"api/activities/api.go:buildReplacementSupervisorIDs":                                       22,
	...
	"api/iot/attendance/handlers.go:(*Resource).handleDailyCheckout":                            18,
	...
	"api/staff/api.go:(*Resource).buildScheduleResponse":                                       19,
	"api/staff/api.go:(*Resource).getStaff":                                                    19,
	"api/staff/api.go:(*Resource).getStaffByRole":                                              17,
	"api/staff/api.go:(*Resource).updateSchedule":                                              20,
	"api/students/api.go:(*Resource).createStudent":                                            35,
	"api/students/api.go:(*Resource).fetchStudentsForList":                                     53,
	"api/students/api.go:(*Resource).updateStudent":                                            41,
	...
	"api/students/attendance_history_handlers.go:(*Resource).getStudentAttendanceHistory":      20,
	"api/students/attendance_history_handlers.go:buildAttendanceHistoryDays":                   45,
	...
	"api/students/export_handlers.go:applyExportFilters":                                       38,
	"api/students/export_handlers.go:exportFilterLabels":                                       22,
	...
	"api/timetable/deviations.go:(*Resource).applySubstituteWrite":                             26,
	...
	"api/timetable/substitute.go:(*Resource).markAbsentOnly":                                   20,
