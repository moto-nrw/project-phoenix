...
var moduleFileSizeAllowlist = map[string]int{
	...
	"modules/studentpresence/internal/application/presence/active_service.go":     1671,
	"modules/studentpresence/internal/application/presence/attendance_service.go": 980,
	"modules/studentpresence/internal/application/presence/session_service.go":    1733,
	"modules/studentpresence/internal/application/presence/transit_service.go":    831,
	"modules/timetable/compose/httpadapter/schedules.go":                          1102,
	...
	"modules/timetable/legacy/timetableplanning/instance_service.go":              3151,
	...
	"modules/timetable/legacy/timetableplanning/timetable_data_service.go":        857,
	"modules/timetable/legacy/timetableplanning/timetable_operations_service.go":  2071,
	"modules/timetable/timetable.go":                                              1928,
	"modules/workforce/inbound/timetracking/api.go":                               935,
	...
	"modules/workforce/legacy/shiftplanning/staff_shift_service.go":               974,
	"modules/workforce/legacy/timetracking/staff_absence_service.go":              2148,
