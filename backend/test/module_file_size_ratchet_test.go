...
var moduleFileSizeAllowlist = map[string]int{
	...
	"modules/identityaccess/compose/account_lifecycle.go":                            838,
	...
	"modules/timetable/legacy/timetableplanning/instance_service.go":                 3152,
	...
	"modules/timetable/legacy/timetableplanning/timetable_operations_service.go":     2072,
