...
var moduleFileSizeAllowlist = map[string]int{
	...
	"modules/identityaccess/compose/account_lifecycle.go":                            893,
	...
	"modules/studentpresence/legacy/services/active/transit_service.go":              831,
	...
	"modules/timetable/legacy/timetableplanning/timetable_data_service.go":           860,
	"modules/timetable/legacy/timetableplanning/timetable_operations_service.go":     2074,
	...
	"workflows/parentportal/legacy/parent_service.go":                                920,
	"workflows/parentportal/legacy/parent_write_service.go":                          1830,
