...
var moduleFileSizeAllowlist = map[string]int{
	...
	"modules/timetable/legacy/timetableplanning/deviation_apply.go":                  1524,
	"modules/timetable/legacy/timetableplanning/instance_service.go":                 3089,
	"modules/timetable/legacy/timetableplanning/materialization_service.go":          1103,
	...
	"modules/timetable/legacy/timetableplanning/timetable_operations_service.go":     2042,
