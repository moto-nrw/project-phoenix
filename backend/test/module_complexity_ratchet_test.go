...
var moduleComplexityAllowlist = map[string]int{
	...
	"modules/timetable/legacy/timetableplanning/attendance_correction.go:(*TemplateService).CorrectInstanceStudentAttendance":             23,
	...
	"modules/timetable/legacy/timetableplanning/instance_series_conversion.go:(*TemplateService).templateAssignmentsOn":                   26,
	...
	"modules/timetable/legacy/timetableplanning/template_create_service.go:(*TemplateService).createTemplateLocked":                       23,
	...
	"modules/timetable/legacy/timetableplanning/template_series_roster.go:(*TemplateService).reconcilePredecessorEnrollmentRows":          34,
	"modules/timetable/legacy/timetableplanning/template_series_roster.go:(*TemplateService).reconcilePredecessorInstanceStaff":           49,
	"modules/timetable/legacy/timetableplanning/template_series_roster.go:(*TemplateService).reconcilePredecessorSegmentRoster":           19,
	"modules/timetable/legacy/timetableplanning/template_series_roster.go:(*TemplateService).reconcilePredecessorSupervisorRows":          44,
	...
	"modules/timetable/legacy/timetableplanning/template_update_service.go:(*TemplateService).resolvePulledForwardStart":                  19,
	"modules/timetable/legacy/timetableplanning/template_update_service.go:(*TemplateService).updateTemplateLocked":                       40,
