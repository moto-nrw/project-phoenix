...
var moduleComplexityAllowlist = map[string]int{
	...
	"modules/studentpresence/internal/application/presence/active_service.go:(*service).GetCrossTenantStudents":                       19,
	"modules/studentpresence/internal/application/presence/active_service.go:(*service).UpdateGroupSupervisor":                        17,
	"modules/studentpresence/internal/application/presence/active_service.go:(*service).createVisit":                                  23,
	"modules/studentpresence/internal/application/presence/active_service.go:(*service).prepareVisitTransfer":                         20,
	"modules/studentpresence/internal/application/presence/active_service.go:(*service).updateActiveGroupLocked":                      21,
	"modules/studentpresence/internal/application/presence/active_service.go:(*service).updateVisit":                                  19,
	"modules/studentpresence/internal/application/presence/attendance_service.go:(*service).getDeviceSupervisorID":                    17,
	"modules/studentpresence/internal/application/presence/attendance_service.go:(*service).performCheckIn":                           28,
	"modules/studentpresence/internal/application/presence/attendance_service.go:(*service).performCheckOut":                          21,
	"modules/studentpresence/internal/application/presence/school_checkin_batch.go:(*service).applyBatchCheckOut":                     21,
	"modules/studentpresence/internal/application/presence/school_checkin_batch.go:(*service).autoClearOnBatchCheckin":                23,
	"modules/studentpresence/internal/application/presence/school_checkin_batch.go:(*service).processSchoolCheckinBatch":              35,
	"modules/studentpresence/internal/application/presence/school_checkin_batch.go:(*service).registerSchoolCheckinBatchBroadcast":    16,
	"modules/studentpresence/internal/application/presence/session_service.go:(*service).UpdateSessionActivity":                       16,
	"modules/studentpresence/internal/application/presence/session_service.go:(*service).executeSessionStart":                         29,
	"modules/studentpresence/internal/application/presence/session_service.go:(*service).forceStartActivitySessionTx":                 20,
	"modules/studentpresence/student_status_day_effective.go:ResolveEffectiveStatus":                                                  18,
	"modules/studentpresence/internal/application/presence/student_status_day_overview.go:statusDayEnrollmentFilter":                  17,
	"modules/studentpresence/internal/application/presence/student_status_day_write.go:(*StudentStatusDayService).BulkCreateForDates": 43,
	"modules/studentpresence/internal/application/presence/student_status_day_write.go:(*StudentStatusDayService).CreateForDates":     20,
	"modules/studentpresence/internal/application/presence/transit_service.go:(*service).assignTransitStudentsToActiveGroup":          35,
	"modules/studentpresence/internal/application/presence/transit_service.go:(*service).ensureCapacityForStudentMove":                18,
	"modules/studentpresence/internal/application/presence/transit_service.go:(*service).lockMoveGroups":                              19,
	"modules/studentpresence/internal/application/presence/transit_service.go:(*service).moveStudentsToActiveGroupLocked":             88,
	"modules/studentpresence/internal/application/presence/transit_service.go:(*service).moveStudentsToTransitLocked":                 17,
	"modules/studentpresence/internal/application/presence/visit_helpers.go:(*service).clearPlannedStatusRows":                        21,
	"modules/studentpresence/internal/application/presence/visit_names.go:(*service).todayVisitNames":                                 23,
