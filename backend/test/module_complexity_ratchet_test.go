...
var moduleComplexityAllowlist = map[string]int{
	...
	"modules/careplan/legacy/careschedule/arrival_service.go:(*arrivalScheduleService).collapseIntoClassTime":                    16,
	"modules/careplan/legacy/careschedule/arrival_service.go:(*arrivalScheduleService).lockClassArrivalStudents":                 16,
	"modules/careplan/legacy/careschedule/care_request_service.go:(*careScheduleRequestService).Correct":                         21,
	"modules/careplan/legacy/careschedule/care_request_service.go:(*careScheduleRequestService).GetForReview":                    16,
	"modules/careplan/legacy/careschedule/care_request_service.go:(*careScheduleRequestService).ListHistory":                     22,
	"modules/careplan/legacy/careschedule/care_request_service.go:(*careScheduleRequestService).applyCareDayChanges":             33,
	"modules/careplan/legacy/careschedule/care_request_service.go:(*careScheduleRequestService).applyCareScheduleRequest":        17,
	"modules/careplan/legacy/careschedule/care_request_service.go:(*careScheduleRequestService).careScheduleDiffFrom":            22,
	"modules/careplan/legacy/careschedule/care_request_service.go:buildCareScheduleChanges":                                      33,
	"modules/careplan/legacy/careschedule/effective_time_service.go:(*effectiveTimeCore).CreateOrReclaimException":               17,
	"modules/careplan/legacy/careschedule/effective_time_service.go:(*effectiveTimeCore).DeleteAllExceptions":                    38,
	"modules/careplan/legacy/careschedule/effective_time_service.go:(*effectiveTimeCore).UpdateException":                        36,
	"modules/careplan/legacy/careschedule/partial_absence_service.go:(*partialAbsenceService).Create":                            31,
	"modules/careplan/legacy/careschedule/partial_absence_service.go:(*partialAbsenceService).Delete":                            33,
	"modules/careplan/legacy/careschedule/partial_absence_service.go:(*partialAbsenceService).Update":                            27,
	"modules/careplan/legacy/careschedule/pickup_auto_excusal.go:(*PickupAutoExcusalSyncer).Sync":                                21,
	"modules/careplan/legacy/careschedule/pickup_baseline_service.go:(*pickupBaselineService).HasBookedOfferingPickupForWeekday": 20,
	"modules/careplan/legacy/careschedule/pickup_schedule_service.go:(*pickupScheduleService).BulkUpsertPickupSchedules":         89,
	"modules/careplan/legacy/careschedule/pickup_schedule_service.go:(*pickupScheduleService).DeleteAllStudentPickupExceptions":  28,
	"modules/careplan/legacy/careschedule/pickup_schedule_service.go:(*pickupScheduleService).UpdateException":                   19,
	...
	"modules/peopledirectory/internal/adapters/postgres/student_enrollment.go:(*StudentStore).ApplyEnrollmentProfile": 24,
	...
	"modules/studentpresence/legacy/services/active/active_service.go:(*service).GetCrossTenantStudents":                       19,
	"modules/studentpresence/legacy/services/active/active_service.go:(*service).UpdateGroupSupervisor":                        17,
	"modules/studentpresence/legacy/services/active/active_service.go:(*service).createVisit":                                  23,
	"modules/studentpresence/legacy/services/active/active_service.go:(*service).prepareVisitTransfer":                         20,
	"modules/studentpresence/legacy/services/active/active_service.go:(*service).updateActiveGroupLocked":                      21,
	"modules/studentpresence/legacy/services/active/active_service.go:(*service).updateVisit":                                  19,
	"modules/studentpresence/legacy/services/active/attendance_service.go:(*service).getDeviceSupervisorID":                    17,
	"modules/studentpresence/legacy/services/active/attendance_service.go:(*service).performCheckIn":                           28,
	"modules/studentpresence/legacy/services/active/attendance_service.go:(*service).performCheckOut":                          21,
	"modules/studentpresence/legacy/services/active/school_checkin_batch.go:(*service).applyBatchCheckOut":                     21,
	"modules/studentpresence/legacy/services/active/school_checkin_batch.go:(*service).autoClearOnBatchCheckin":                23,
	"modules/studentpresence/legacy/services/active/school_checkin_batch.go:(*service).processSchoolCheckinBatch":              35,
	"modules/studentpresence/legacy/services/active/school_checkin_batch.go:(*service).registerSchoolCheckinBatchBroadcast":    16,
	"modules/studentpresence/legacy/services/active/session_service.go:(*service).UpdateSessionActivity":                       16,
	"modules/studentpresence/legacy/services/active/session_service.go:(*service).executeSessionStart":                         29,
	"modules/studentpresence/legacy/services/active/session_service.go:(*service).forceStartActivitySessionTx":                 20,
	"modules/studentpresence/legacy/services/active/student_status_day_effective.go:ResolveEffectiveStatus":                    18,
	"modules/studentpresence/legacy/services/active/student_status_day_overview.go:statusDayEnrollmentFilter":                  17,
	"modules/studentpresence/legacy/services/active/student_status_day_write.go:(*StudentStatusDayService).BulkCreateForDates": 43,
	"modules/studentpresence/legacy/services/active/student_status_day_write.go:(*StudentStatusDayService).CreateForDates":     20,
	"modules/studentpresence/legacy/services/active/transit_service.go:(*service).assignTransitStudentsToActiveGroup":          35,
	"modules/studentpresence/legacy/services/active/transit_service.go:(*service).ensureCapacityForStudentMove":                18,
	"modules/studentpresence/legacy/services/active/transit_service.go:(*service).lockMoveGroups":                              19,
	"modules/studentpresence/legacy/services/active/transit_service.go:(*service).moveStudentsToActiveGroupLocked":             88,
	...
	"modules/timetable/internal/application/activity_instances.go:(*Service).PatchActivityInstance":                                                  18,
	"modules/timetable/internal/application/activity_instances.go:(*Service).lockOperationalInstanceStaff":                                           20,
	"modules/timetable/internal/application/care_exit_roster.go:(*Service).validateCareExitRosterReferences":                                         30,
	...
	"modules/timetable/legacy/timetableplanning/edited_instance_detection.go:(*materializationService).DetectEditedInWindow":                         56,
	"modules/timetable/legacy/timetableplanning/edited_instance_detection.go:(*materializationService).expectedSlotsOn":                              23,
	...
	"modules/timetable/legacy/timetableplanning/instance_conflict.go:plannedStaffConflicts":                                                          18,
	...
	"modules/timetable/legacy/timetableplanning/materialization_service.go:(*materializationService).materializeTemplate":                            60,
	...
	"modules/timetable/legacy/timetableplanning/staff_pool.go:buildStaffPoolFacts":                                                                   20,
	...
	"modules/timetable/legacy/timetableplanning/timetable_read_exception_conflicts.go:(*TimetableDataService).fillArrivalSchedules":                  18,
	"modules/timetable/legacy/timetableplanning/timetable_read_exception_conflicts.go:(*TimetableDataService).loadArrivalPreload":                    23,
	...
	"modules/timetable/legacy/timetableplanning/timetable_read_student_week.go:(*TimetableDataService).preloadArrivalSchedules":                      17,
	...
	"modules/workforce/legacy/shiftplanning/staff_assignment_service.go:(*staffAssignmentService).ListAssignmentsForStaff":           16,
	"modules/workforce/legacy/shiftplanning/staff_schedule_overview.go:(*staffScheduleOverviewService).loadOverviewData":             17,
	"modules/workforce/legacy/shiftplanning/staff_schedule_overview.go:(*staffScheduleOverviewService).resolveWeeklyTargets":         52,
	"modules/workforce/legacy/shiftplanning/staff_shift_move.go:(*staffShiftService).MoveShift":                                      42,
	"modules/workforce/legacy/shiftplanning/staff_shift_series_service.go:(*staffShiftSeriesService).SplitSeries":                    38,
	"modules/workforce/legacy/shiftplanning/staff_shift_series_service.go:(*staffShiftSeriesService).materializeSeries":              32,
	"modules/workforce/legacy/shiftplanning/staff_shift_service.go:(*staffShiftService).ApplyCancellation":                           49,
	"modules/workforce/legacy/shiftplanning/staff_shift_service.go:(*staffShiftService).DeleteShift":                                 16,
	"modules/workforce/legacy/shiftplanning/staff_shift_service.go:(*staffShiftService).updateShiftWithOptions":                      45,
	...
	"workflows/parentportal/legacy/parent_consent_service.go:(*service).setPhotoConsent":                           59,
	"workflows/parentportal/legacy/parent_guardian_service.go:(*service).CreateGuardianContact":                    42,
	"workflows/parentportal/legacy/parent_guardian_service.go:(*service).ListChildGuardians":                       25,
	"workflows/parentportal/legacy/parent_guardian_service.go:(*service).UpdateGuardianContact":                    74,
	"workflows/parentportal/legacy/parent_guardian_service.go:(*service).UpdateGuardianRelationship":               76,
	"workflows/parentportal/legacy/parent_guardian_service.go:projectChildGuardian":                                17,
	"workflows/parentportal/legacy/parent_guardian_service.go:validateContactInput":                                30,
	"workflows/parentportal/legacy/parent_master_data_request_service.go:(*service).SubmitMasterDataChangeRequest": 56,
	"workflows/parentportal/legacy/parent_master_data_service.go:(*service).UpdateMasterDataField":                 24,
	"workflows/parentportal/legacy/parent_master_data_service.go:(*service).applyGuardianPhoneEdit":                18,
	"workflows/parentportal/legacy/parent_master_data_service.go:(*service).applyGuardianProfileEdit":              18,
	"workflows/parentportal/legacy/parent_related_accounts_service.go:(*service).ListRelatedAccounts":              16,
	"workflows/parentportal/legacy/parent_related_accounts_service.go:(*service).relatedAccountStatus":             18,
	"workflows/parentportal/legacy/parent_service.go:(*service).ListEnrollableForAccount":                          19,
	"workflows/parentportal/legacy/parent_write_service.go:(*service).ChildFeatures":                               40,
	"workflows/parentportal/legacy/parent_write_service.go:(*service).DeleteCareException":                         35,
	"workflows/parentportal/legacy/parent_write_service.go:(*service).SubmitPickupChangeRequest":                   34,
	"workflows/parentportal/legacy/parent_write_service.go:(*service).SubmitSickNote":                              58,
	"workflows/parentportal/legacy/parent_write_service.go:(*service).enrichLegacyPickupChangeRequests":            16,
	"workflows/parentportal/legacy/parent_write_service.go:(*service).hasOpenChangeRequest":                        24,
	"workflows/parentportal/legacy/parent_write_service.go:(*service).loadCareException":                           18,
	"workflows/parentportal/legacy/parent_write_service.go:(*service).submitCareException":                         44,
	"workflows/parentportal/legacy/parent_write_service.go:mergeCareExceptions":                                    20,
