...
// TestPasswordTooWeak tests the password complexity rules.
func TestPasswordTooWeak(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.wantErr, PasswordTooWeak(tt.password),
				"password complexity verdict")
		})
	}
}
