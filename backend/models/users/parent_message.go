...
func (m *ParentMessage) GetID() any              { return m.ID }
func (m *ParentMessage) GetCreatedAt() time.Time { return m.CreatedAt }
func (m *ParentMessage) GetUpdatedAt() time.Time { return m.UpdatedAt }
