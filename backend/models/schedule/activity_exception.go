...
type ActivityExceptionRepository interface {
	...
	FindByActivityGroupAndDate(ctx context.Context, activityGroupID int64, date Date) (*ActivityException, error)
	...
	FindByActivityGroupAndDateRange(ctx context.Context, activityGroupID int64, from, to Date) ([]*ActivityException, error)
	...
	FindByDateRange(ctx context.Context, from, to Date) ([]*ActivityException, error)
