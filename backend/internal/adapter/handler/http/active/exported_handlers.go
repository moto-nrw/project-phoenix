...
func (rs *Resource) CreateActiveGroupHandler() http.HandlerFunc { return rs.createActiveGroup }
func (rs *Resource) UpdateActiveGroupHandler() http.HandlerFunc { return rs.updateActiveGroup }
func (rs *Resource) DeleteActiveGroupHandler() http.HandlerFunc { return rs.deleteActiveGroup }
...
func (rs *Resource) GetStudentVisitsHandler() http.HandlerFunc { return rs.getStudentVisits }
...
func (rs *Resource) GetStaffSupervisionsHandler() http.HandlerFunc { return rs.getStaffSupervisions }
...
func (rs *Resource) GetDashboardAnalyticsHandler() http.HandlerFunc { return rs.getDashboardAnalytics }
func (rs *Resource) GetRoomUtilizationHandler() http.HandlerFunc    { return rs.getRoomUtilization }
func (rs *Resource) GetStudentAttendanceHandler() http.HandlerFunc  { return rs.getStudentAttendance }
...
func (rs *Resource) GetActiveGroupsByRoomHandler() http.HandlerFunc { return rs.getActiveGroupsByRoom }
func (rs *Resource) GetActiveGroupsByGroupHandler() http.HandlerFunc {
	return rs.getActiveGroupsByGroup
}
func (rs *Resource) GetActiveGroupVisitsHandler() http.HandlerFunc { return rs.getActiveGroupVisits }
...
func (rs *Resource) GetVisitsByGroupHandler() http.HandlerFunc      { return rs.getVisitsByGroup }
func (rs *Resource) GetSupervisorsByGroupHandler() http.HandlerFunc { return rs.getSupervisorsByGroup }
...
func (rs *Resource) AddGroupToCombinationHandler() http.HandlerFunc { return rs.addGroupToCombination }
