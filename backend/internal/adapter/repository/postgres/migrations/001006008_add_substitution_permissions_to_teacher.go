...
func addSubstitutionPermissionsToRoles(ctx context.Context, db *bun.DB) error {
	logger.Logger.Info("Adding substitution permissions to teacher and staff roles...")
	...
	if err != nil {
		...
		logger.Logger.Warnf("Note: Could not add permissions to staff role (role might not exist): %v", err)
	}
	...
	logger.Logger.Info("Successfully added substitution permissions to teacher and staff roles")
	return nil
}

func removeSubstitutionPermissionsFromRoles(ctx context.Context, db *bun.DB) error {
	logger.Logger.Info("Removing substitution permissions from teacher and staff roles...")
	...
	logger.Logger.Info("Successfully removed substitution permissions from teacher and staff roles")
	return nil
}
