...
func createImportPerformanceIndexes(ctx context.Context, db *bun.DB) error {
	...
	logger.Logger.Info("✓ Migration 1.6.18: Performance indexes created successfully")
	return nil
}
...
func dropImportPerformanceIndexes(ctx context.Context, db *bun.DB) error {
	...
	logger.Logger.Info("✓ Migration 1.6.18: Performance indexes dropped successfully")
	return nil
}
