...
// AccountPermissionRepository implements authPort.AccountPermissionRepository interface
...
func NewAccountPermissionRepository(db *bun.DB) authPort.AccountPermissionRepository {
