...
func TestNewTokenAuthWithSecret_ValidSecret(t *testing.T) {
	...
	auth, err := NewTokenAuthWithSecret(testSecret, viper.GetDuration("auth_jwt_expiry"), viper.GetDuration("auth_jwt_refresh_expiry"))
...
func TestNewTokenAuthWithSecret_EmptySecret(t *testing.T) {
	...
	auth, err := NewTokenAuthWithSecret("", viper.GetDuration("auth_jwt_expiry"), viper.GetDuration("auth_jwt_refresh_expiry"))
	require.NoError(t, err)
	assert.NotNil(t, auth)
}
...
func TestNewTokenAuthWithSecret_ShortSecret(t *testing.T) {
	...
	auth, err := NewTokenAuthWithSecret("short", viper.GetDuration("auth_jwt_expiry"), viper.GetDuration("auth_jwt_refresh_expiry"))
	require.NoError(t, err)
	assert.NotNil(t, auth)
}
...
func TestTokenAuth_VerifyWithWrongSecret(t *testing.T) {
	...
	auth1, err := NewTokenAuthWithSecret("secret-one-32-chars-minimum!!!!", viper.GetDuration("auth_jwt_expiry"), viper.GetDuration("auth_jwt_refresh_expiry"))
	require.NoError(t, err)
	...
	auth2, err := NewTokenAuthWithSecret("secret-two-32-chars-minimum!!!!", viper.GetDuration("auth_jwt_expiry"), viper.GetDuration("auth_jwt_refresh_expiry"))
	require.NoError(t, err)
