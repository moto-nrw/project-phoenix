...
func TestShouldExposeInvitationToken(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "demo internal host allows", env: "demo", host: "server:8080", header: "true", want: true},
		{name: "demo public host denies", env: "demo", host: "api.demo.moto-app.de", header: "true", want: false},
		{name: "demo without header denies", env: "demo", host: "server:8080", want: false},
		{name: "production internal host denies", env: "production", host: "server:8080", header: "true", want: false},
		{name: "staging internal host denies", env: "staging", host: "server:8080", header: "true", want: false},
