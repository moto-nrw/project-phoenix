...
const (
	studentStatusDaysParentSourceVersion     = "1.15.112"
...
func studentStatusDaysParentSourceUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.112: Allowing parent student status day source...")
...
func studentStatusDaysParentSourceDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.112: Removing parent student status day source...")
