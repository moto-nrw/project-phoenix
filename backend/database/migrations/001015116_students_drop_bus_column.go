...
const (
	studentsDropBusColumnVersion     = "1.15.116"
...
func studentsDropBusColumnUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.116: Dropping legacy users.students.bus column...")
...
func studentsDropBusColumnDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.116: Re-adding users.students.bus column...")
