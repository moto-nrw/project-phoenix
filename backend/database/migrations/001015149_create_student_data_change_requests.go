...
const (
	createStudentDataChangeRequestsVersion     = "1.15.149"
...
func createStudentDataChangeRequestsUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.149: Creating users.student_data_change_requests table...")
...
func createStudentDataChangeRequestsDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.149: Dropping users.student_data_change_requests...")
