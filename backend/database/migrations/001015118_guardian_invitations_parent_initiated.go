...
const (
	guardianInvitationsParentInitiatedVersion     = "1.15.118"
...
func guardianInvitationsParentInitiatedUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.118: Extending auth.guardian_invitations for parent-initiated invites...")
...
func guardianInvitationsParentInitiatedDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.118: dropping parent-initiated columns...")
