...
const (
	auditDataAccessLogMetadataVersion     = "1.15.99"
...
func addAuditDataAccessLogMetadata(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.99: Adding metadata column to audit.data_access_log...")
...
func dropAuditDataAccessLogMetadata(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.99: Dropping audit.data_access_log.metadata...")
