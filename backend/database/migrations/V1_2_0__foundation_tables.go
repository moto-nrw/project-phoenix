...
func init() {
	...
	migration := &Migration{
		Version:     FoundationTablesVersion,
		Description: FoundationTablesDescription,
		DependsOn:   []string{"1.1.0"}, // Depends on authentication foundation
		Up:          foundationTablesUp,
		Down:        foundationTablesDown,
	}
