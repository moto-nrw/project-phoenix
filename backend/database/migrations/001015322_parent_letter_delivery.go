...
const (
	parentLetterDeliveryVersion     = "1.15.322"
...
func parentLetterDeliveryUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.322: Adding Elternbrief delivery mode and per-recipient delivery records...")
...
func parentLetterDeliveryDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.322: Dropping Elternbrief delivery mode and delivery records...")
