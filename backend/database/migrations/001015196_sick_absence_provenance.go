...
const (
	sickAbsenceProvenanceVersion     = "1.15.196"
...
func init() {
	...
	Migrations.MustRegister(
		func(ctx context.Context, db *bun.DB) error {
			fmt.Println("Migration 1.15.196: Adding sick_absence_id provenance columns (#1843)...")
		...
		func(ctx context.Context, db *bun.DB) error {
			fmt.Println("Rolling back migration 1.15.196...")
			if _, err := db.NewRaw(`
