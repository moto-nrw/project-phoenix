...
const (
	categoryShiftTypeVersion     = "1.15.191"
...
func categoryShiftTypeUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.191: Linking activities.categories to schedule.shift_types...")
...
func categoryShiftTypeDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.191: Removing category shift_type_id link...")
