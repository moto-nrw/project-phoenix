...
const (
	createRequestChildOfferingsVersion     = "1.15.53"
...
func createRequestChildOfferingsUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.53: Creating enrollment.request_child_offerings table...")
...
func createRequestChildOfferingsDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.53: Dropping enrollment.request_child_offerings...")
