...
const (
	authMFATrustedDevicesVersion     = "1.15.81"
...
func authMFATrustedDevicesUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.81: Creating auth.mfa_trusted_devices table...")
...
func authMFATrustedDevicesDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.81: Dropping auth.mfa_trusted_devices...")
