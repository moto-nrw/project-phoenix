...
const (
	personalCalendarVersion     = "1.15.157"
...
func personalCalendarUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.157: Creating personal calendar tables...")
	...
	fmt.Println("Migration 1.15.157: Successfully created personal calendar tables")
	return tx.Commit()
}

func personalCalendarDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.157: Dropping personal calendar tables...")
