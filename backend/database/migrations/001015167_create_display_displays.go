...
const (
	createDisplayDisplaysVersion     = "1.15.167"
...
func createDisplayDisplaysUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.167: Creating display schema + display.displays table...")
...
func createDisplayDisplaysDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.167: Dropping display.displays...")
