...
const (
	parentAnnouncementsVersion     = "1.15.154"
...
func parentAnnouncementsUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.154: Creating parent announcement tables...")
...
func parentAnnouncementsDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.154: Dropping parent announcement tables...")
