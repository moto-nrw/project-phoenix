...
func groupNotesUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.190: Adding notes (Wochennotiz) column to activities.groups...")
...
func groupNotesDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.190: Removing notes column from activities.groups...")
