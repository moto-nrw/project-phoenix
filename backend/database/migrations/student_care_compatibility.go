...
// Versioned rollback definitions after absence compatibility fields move to Care
// Plan. Guardian copies remain archive-only.
const studentCareCompatibilityView = `
...
const studentCareCompatibilityRouting = `
