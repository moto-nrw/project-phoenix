...
const (
	platformOperatorMFAVersion     = "1.15.83"
...
func platformOperatorMFAUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.83: Creating platform.operator_mfa_* tables...")
...
func platformOperatorMFADown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.83: Dropping platform.operator_mfa_* tables...")
