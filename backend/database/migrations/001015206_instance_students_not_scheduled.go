...
// stays FALSE for every existing row: migration 1.15.205 already flipped the
// legacy completed+expected rows to 'absent', which is the state the regular
// completion path would have written for them.
