...
func init() {
	// Migration 1: Initial infrastructure setup
	Migrations.MustRegister(
		func(ctx context.Context, db *bun.DB) error {
			fmt.Println("Migration 1: Setting up migration infrastructure...")
		...
		func(ctx context.Context, db *bun.DB) error {
			fmt.Println("Rolling back migration 1: Removing infrastructure setup...")
