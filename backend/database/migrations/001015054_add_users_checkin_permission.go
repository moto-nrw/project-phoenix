...
const (
	addUsersCheckinPermissionVersion     = "1.15.54"
...
func addUsersCheckinPermissionUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.54: Adding users:checkin permission and granting to user role...")
...
func addUsersCheckinPermissionDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.54: Removing users:checkin permission...")
