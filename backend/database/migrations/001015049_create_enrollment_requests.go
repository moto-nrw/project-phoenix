...
const (
	createEnrollmentRequestsVersion     = "1.15.49"
...
func createEnrollmentRequestsUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.49: Creating enrollment.requests table...")
...
func createEnrollmentRequestsDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.49: Dropping enrollment.requests...")
