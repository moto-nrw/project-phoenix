...
const (
	pushSubscriptionsVersion     = "1.15.238"
...
func pushSubscriptionsUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.238: Creating iot.push_subscriptions...")
...
func pushSubscriptionsDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.238: Dropping iot.push_subscriptions...")
