...
const (
	excusedAbsenceRequestsVersion     = "1.15.171"
...
func excusedAbsenceRequestsUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.171: Creating active.excused_absence_requests...")
...
func excusedAbsenceRequestsDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.171: Dropping active.excused_absence_requests...")
