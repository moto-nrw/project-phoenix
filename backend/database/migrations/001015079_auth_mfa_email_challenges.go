...
const (
	authMFAEmailChallengesVersion     = "1.15.79"
...
func authMFAEmailChallengesUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.79: Creating auth.mfa_email_challenges table...")
...
func authMFAEmailChallengesDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.79: Dropping auth.mfa_email_challenges...")
