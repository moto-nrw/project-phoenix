...
const (
	createEnrollmentRequestChildrenVersion     = "1.15.50"
...
func createEnrollmentRequestChildrenUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.50: Creating enrollment.request_children table...")
...
func createEnrollmentRequestChildrenDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.50: Dropping enrollment.request_children...")
