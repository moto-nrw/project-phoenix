...
const (
	migrateOpenCareRequestsVersion     = "1.15.160"
...
func migrateOpenCareRequestsUp(ctx context.Context, db *bun.DB) error {
	fmt.Println("Migration 1.15.160: Moving open care_schedule chat requests to schedule.care_schedule_change_requests...")
...
func migrateOpenCareRequestsDown(ctx context.Context, db *bun.DB) error {
	fmt.Println("Rolling back migration 1.15.160: Restoring open care requests into users.parent_messages...")
