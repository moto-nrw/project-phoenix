...
// the directory behind RoomDirectory instead of the former SQL join.
type DirectoryRoom struct {
	ID       int64
	TenantID int64
}

// RoomDirectory is the owner query the roster restore validates room
...
var errRoomDirectoryRequired = errors.New("schedule repositories: room directory is not bound")
...
// room deleted in the meantime restores as NULL, as the former join did.
