...
// WorkforceShiftSeriesRows serves the schedule.staff_shift_series recurrence rules.
type WorkforceShiftSeriesRows struct{ workforce workforce.Capability }

// NewWorkforceShiftSeriesRows binds the series rows to the Workforce capability.
func NewWorkforceShiftSeriesRows(capability workforce.Capability) *WorkforceShiftSeriesRows {
	if capability == nil {
		panic("staff shift series rows: Workforce capability is required")
	}
	return &WorkforceShiftSeriesRows{workforce: capability}
}

func (r *WorkforceShiftSeriesRows) Create(ctx context.Context, series *scheduleModels.StaffShiftSeries) error {
	if series == nil {
...
func (r *WorkforceShiftSeriesRows) FindByID(ctx context.Context, id any) (*scheduleModels.StaffShiftSeries, error) {
...
func (r *WorkforceShiftSeriesRows) Update(ctx context.Context, series *scheduleModels.StaffShiftSeries) error {
	if series == nil {
		return errors.New("StaffShiftSeries cannot be nil or zero value")
	}
	if err := series.Validate(); err != nil {
...
func (r *WorkforceShiftSeriesRows) Delete(ctx context.Context, id any) error {
	seriesID, err := shiftRowID(id)
	if err != nil {
		return wrapShiftDatabaseError("delete", err)
	}
...
func (r *WorkforceShiftSeriesRows) CapValidUntil(ctx context.Context, id int64, until scheduleModels.Date) error {
...
func (r *WorkforceShiftSeriesRows) FindOverlappingInLineage(ctx context.Context, rootID, excludeID int64, from scheduleModels.Date) (*scheduleModels.StaffShiftSeries, error) {
...
// WorkforceShiftSeriesExceptionRows serves the deliberately removed single
// occurrences of a series.
type WorkforceShiftSeriesExceptionRows struct{ workforce workforce.Capability }

// NewWorkforceShiftSeriesExceptionRows binds the series exception rows to the
// Workforce capability.
func NewWorkforceShiftSeriesExceptionRows(capability workforce.Capability) *WorkforceShiftSeriesExceptionRows {
	if capability == nil {
		panic("staff shift series exception rows: Workforce capability is required")
	}
	return &WorkforceShiftSeriesExceptionRows{workforce: capability}
}

func (r *WorkforceShiftSeriesExceptionRows) Create(ctx context.Context, exception *scheduleModels.StaffShiftSeriesException) error {
	if exception == nil {
...
func (r *WorkforceShiftSeriesExceptionRows) FindDatesBySeriesID(ctx context.Context, seriesID int64) ([]scheduleModels.Date, error) {
...
func (r *WorkforceShiftSeriesExceptionRows) RepointToSeriesFrom(ctx context.Context, fromSeriesID, toSeriesID int64, from scheduleModels.Date) (int64, error) {
