...
Portalen. Ergänzt ADR 0024, der Format und Plattform festlegt; hier geht es um
...
- **Zwei Inhaltsbestände wären der Fehler, nicht zwei Einstiege.** Grob ein
  ...
  passieren (ADR 0024) — oder quer verlinkt, womit es wieder ein Bestand mit
...
- **Der primäre Personalisierungsmechanismus ist der kontextuelle Deep-Link aus
  ...
  das Thema Betreuungsplan. Voraussetzung ist die Route pro Thema aus ADR 0024.
