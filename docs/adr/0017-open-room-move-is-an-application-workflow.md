...
Presence exposes the room session and the move publicly. The inbound Student
Presence route (`modules/studentpresence/inbound/presence`) and the API root
call the public contract and the composition, which is the target shape.
