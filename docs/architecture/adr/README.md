...
This directory contains Architecture Decision Records (ADRs) documenting significant architectural decisions made in Project Phoenix.
...
ADRs are numbered sequentially: `001-factory-pattern.md`, `002-multi-schema-database.md`, etc.
...
**Status:** Superseded by [ADR-012: Migrate to SQLBoiler](012-migrate-sqlboiler.md)
```
...
We needed to organize ~60 tables for different business domains. Options considered:
...
**Maintainer**: Project Phoenix Team
